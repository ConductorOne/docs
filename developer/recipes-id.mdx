...
<CardGroup cols={2}>
  <Card title="Testing recipes" icon="flask" href="/developer/recipes-testing">
    Mock servers and testability patterns
  </Card>
  <Card title="Caching recipes" icon="database" href="/developer/recipes-caching">
    Thread-safe caching and anti-patterns
  </Card>
</CardGroup>
