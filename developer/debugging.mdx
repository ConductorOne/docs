...
Check:
- Connector registered in C1.ai admin UI
- Sync scheduled
...
After running a sync, you see duplicate resources in C1.ai: one created via Terraform/API and a separate one discovered by the connector.
