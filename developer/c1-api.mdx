...
sidebarTitle: "C1 API"
description: "How connectors communicate with the C1 platform in daemon mode."
---
...
| Connector Error | SDK Handling | C1 Action |
|-----------------|--------------|---------------------|
...
| Cancelled by C1 | Stop processing | Task cancelled |
...
| `connection refused` | Network/firewall issue | Check connectivity to C1 |
