...
<CardGroup cols={2}>
  <Card title="Resource modeling" icon="sitemap" href="/developer/recipes-modeling">
    Hierarchies and display name patterns
  </Card>
  <Card title="ID correlation" icon="link" href="/developer/recipes-id">
    RawId annotation and per-connector ID formats
  </Card>
</CardGroup>
