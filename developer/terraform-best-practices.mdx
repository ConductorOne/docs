...
The following example creates a group in the C1 application and automatically adds any user whose `department` attribute contains "engineering."
...
- **The C1 app ID is stable within your tenant.** You can look it up once with a data source, or store it as a local variable if you reference it in multiple places.
