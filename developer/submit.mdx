...
You've built a connector that works. Publishing makes it available to everyone using C1.ai:
...
**Option A: Open source under C1.ai**
- Work with C1.ai to host in their GitHub org
...
3. Contact C1.ai if you want official hosting:
...
- **DO** send a private report to [security@c1.ai](mailto:security@c1.ai)
