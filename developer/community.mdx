...
| C1.ai Support | Hours | Production issues (customers), product feature requests |
...
The Baton ecosystem is maintained by C1.ai with community input.

| Decision type | Who decides |
|--------------|-------------|
| SDK changes | C1.ai team |
| New connectors (C1.ai org) | C1.ai team |
...
| Security Reports | security@c1.ai |
| Code of Conduct Reports | open-source@c1.ai |
