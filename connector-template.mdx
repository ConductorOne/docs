...
<Steps>
  ...
  <Step>
    ...
    <Warning>
    The **scope:name** scope is used by C1 when automatically provisioning and deprovisioning access. **If you do not want ConductorOne to perform these tasks, do not give your token this scope.**
    </Warning>
