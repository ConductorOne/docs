...
Example:
baton repo: baton-jira-datacenter 
doc file name: jira-datacenter
connector name: Atlassian Jira Data Center
app name: Jira Data Center  */}
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    <Steps>
      <Step>
        1. In ConductorOne, navigate to **Integrations** > **Connectors** > **Add connector**.
