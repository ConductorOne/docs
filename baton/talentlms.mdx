...
description: "C1.ai provides identity governance for TalentLMS. Integrate your TalentLMS account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for TalentLMS. Integrate your TalentLMS account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "TalentLMS"
---

{/* stargate: cf-talentlms-20260605 */}

C1.ai provides identity governance for TalentLMS. Integrate your TalentLMS account
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your TalentLMS connector is now pulling access data into C1.ai.
  </Tab>
