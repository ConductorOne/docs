...
description: "C1.ai provides identity governance for Sysdig. Integrate your Sysdig account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Sysdig. Integrate your Sysdig account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Sysdig"
---

C1.ai provides identity governance for Sysdig. Integrate your Sysdig account with
C1.ai for unified visibility and governance over who belongs to which teams and
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Sysdig connector is now pulling access data into C1.ai.
  </Tab>
