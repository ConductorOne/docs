...
description: "C1.ai provides identity governance for Mulesoft. Integrate your Mulesoft instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Mulesoft. Integrate your Mulesoft instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Salesforce Mulesoft"
---

C1.ai provides identity governance for Mulesoft Anypoint Platform. Integrate your
Anypoint organization with C1.ai for unified visibility and governance over user,
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Mulesoft connector is now pulling access data into C1.ai.
  </Tab>
