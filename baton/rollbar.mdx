...
description: "C1.ai provides identity governance for Rollbar. Integrate your Rollbar instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Rollbar. Integrate your Rollbar instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Rollbar"
---

C1.ai provides identity governance for Rollbar. Integrate your Rollbar
account with C1.ai for unified visibility and governance over who belongs to
which teams.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Rollbar connector is now pulling access data into C1.ai.
  </Tab>
