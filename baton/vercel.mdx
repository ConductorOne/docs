...
description: "ConductorOne provides identity governance and just-in-time provisioning for Vercel. Integrate your Vercel instance with ConductorOne to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "ConductorOne provides identity governance and just-in-time provisioning for Vercel. Integrate your Vercel instance with ConductorOne to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
sidebarTitle: "Vercel"
---
...
| :--- | :--- | :--- |
| Users | <Icon icon="square-check" iconType="solid" color="#65DE23"/> | Create |
| Teams | <Icon icon="square-check" iconType="solid" color="#65DE23"/> | Grant, Revoke |
| Access Groups | <Icon icon="square-check" iconType="solid" color="#65DE23"/> | Grant, Revoke |
| Projects | <Icon icon="square-check" iconType="solid" color="#65DE23"/> | Grant, Revoke |
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **That's it!** Your Vercel connector is now pulling access data into ConductorOne.
  </Tab>
