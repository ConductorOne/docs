...
description: "C1.ai provides identity governance and just-in-time provisioning for Vercel. Integrate your Vercel instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1.ai provides identity governance and just-in-time provisioning for Vercel. Integrate your Vercel instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
sidebarTitle: "Vercel"
---
...
<Note>
Projects and Access Groups are Enterprise-only features in Vercel. If you are using a Hobby or Pro plan, disable the **Projects** and **Access Groups** resource types from the C1.ai UI to avoid 403 authorization errors during sync.
...
<Note>
**Grant expansion**: The connector syncs Access Group → Project role mappings as grant expansion, allowing C1.ai to derive transitive project access for Enterprise accounts.
</Note>
