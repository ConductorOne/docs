...
description: "C1.ai provides identity governance and just-in-time provisioning for Treasure AI. Integrate your Treasure AI instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1.ai provides identity governance and just-in-time provisioning for Treasure AI. Integrate your Treasure AI instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
...
Policies and Policy Groups require the PBAC paid add-on. These resources are opt-in and can be enabled from the C1.ai connector settings. Without opt-in, only Users and Roles are synced.
...
<Steps>
  ...
  <Step>
    If your account has IP allowlisting enabled, add C1.ai's egress IP range(s) to the allowlist for the service user.
  </Step>
</Steps>
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **Done.** Your Treasure AI connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1.ai, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the Treasure AI connector to. Treasure AI data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>
