...
* Due to limitations on the GitHub API, syncing multiple orgs requires a PAT. A separate connector and GitHub app is required when using the GitHub App integration.
