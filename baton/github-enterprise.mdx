...
<Warning>
Self-hosted deployment requires **baton-github-enterprise v0.0.4 or later**. Earlier versions fail to register with ConductorOne when deployed in minimal container environments (for example, Debian Bookworm slim on Kubernetes) due to missing OS info fallbacks.
</Warning>
...
- The **Connector Administrator** or **Super Administrator** role in ConductorOne
- A **Client ID** and **Client Secret** from ConductorOne (navigate to **Settings** > **API Credentials** to generate these)
...
<Step>
The connector connects to your ConductorOne tenant and begins syncing. Verify it appears as **Connected** in **Integrations** > **Connectors**.
</Step>
</Steps>
