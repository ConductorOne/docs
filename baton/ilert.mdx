...
description: "C1.ai provides identity governance for ilert. Integrate your ilert account with C1.ai for unified visibility and governance over user and team access."
og:description: "C1.ai provides identity governance for ilert. Integrate your ilert account with C1.ai for unified visibility and governance over user and team access."
sidebarTitle: "ilert"
---

C1.ai provides identity governance for ilert. Integrate your ilert account with
C1.ai for unified visibility and governance over user and team access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your ilert connector is now pulling access data into C1.ai.
  </Tab>
