...
description: "C1.ai provides identity governance for Harvest. Integrate your Harvest account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Harvest. Integrate your Harvest account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Harvest"
---

C1.ai provides identity governance for Harvest. Integrate your Harvest account
with C1.ai for unified visibility and governance over the people who can access
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Harvest connector is now pulling access data into C1.ai.
  </Tab>
