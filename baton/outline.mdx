...
description: "C1.ai provides identity governance for Outline. Integrate your Outline instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Outline. Integrate your Outline instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Outline"
---

C1.ai provides identity governance for Outline. Integrate your Outline
...
- The connector requests users of every status. If your Outline server
  ...
  not appear in C1.ai until they are active.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Outline connector is now pulling access data into C1.ai.
  </Tab>
