...
description: "C1.ai provides identity governance for LiveAgent. Integrate your LiveAgent account with C1.ai for unified visibility and governance over agent access."
og:description: "C1.ai provides identity governance for LiveAgent. Integrate your LiveAgent account with C1.ai for unified visibility and governance over agent access."
sidebarTitle: "LiveAgent"
---

{/* stargate: cf-liveagent-20260605 */}

C1.ai provides identity governance for LiveAgent. Integrate your LiveAgent account
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your LiveAgent connector is now pulling access data into C1.ai.
  </Tab>
