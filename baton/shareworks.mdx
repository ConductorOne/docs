...
description: "C1.ai provides identity governance for Shareworks. Integrate your Shareworks instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Shareworks. Integrate your Shareworks instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Shareworks"
---

C1.ai provides identity governance for Shareworks by Morgan Stanley. Integrate your
Shareworks instance with C1.ai for unified visibility and governance over equity
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Shareworks connector is now pulling access data into C1.ai.
  </Tab>
