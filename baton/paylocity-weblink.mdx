...
og:title: "Set up a Paylocity Weblink connector - C1 docs"
og:description: "Integrate your Paylocity Weblink instance with C1 to run user access reviews, enable just-in-time access requests, and automatically provision and deprovision access."
description: "C1 provides identity governance for Paylocity Weblink. Integrate your Paylocity Weblink instance with C1 to run user access reviews (UARs) and sync employee data."
...
Use this connector if you need to avoid transmitting sensitive PII data to C1.
</Tip>
  ...
  <Tab title="Self-hosted">
    ...
    * [GitHub repository](https://github.com/ConductorOne/baton-paylocity-weblink): Access the source code, report issues, or contribute to the project.
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the Paylocity Weblink connector to. Paylocity Weblink data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>
