...
The Slack Enterprise Grid connector supports [automatic account provisioning and deprovisioning](/product/admin/account-provisioning). 

*The connector can sync and provision IdP groups only if SSO is configured for your Slack Enterprise Grid instance. 
