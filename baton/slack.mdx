...
If you want to install the C1 Slack app, so that you and your colleagues can request access and get notifications about new ConductorOne tasks in your Slack workspace, go to the **Settings** page in C1 and click **Notifications**.
</Warning>
