...
If you want to install the ConductorOne Slack app, so that you and your colleagues can request access and get notifications about new ConductorOne tasks in your Slack workspace, go to the **Settings** page in C1 and click **Notifications**.
</Warning>
...
<Step>
Give your new Slack app a name, such as "ConductorOne integration", and select the workspace you want to integrate with C1.
</Step>
<Step>
Click **Create App**.
</Step>
