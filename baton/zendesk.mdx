...
og:title: Set up a Zendesk connector - C1 docs
og:description: C1 provides identity governance for Zendesk. Integrate your Zendesk instance with C1 to run user access reviews (UARs) and enable just-in-time access requests.
description: C1 provides identity governance for Zendesk. Integrate your Zendesk instance with C1 to run user access reviews (UARs) and enable just-in-time access requests.
