...
description: "C1.ai provides identity governance for Forma. Integrate your Forma instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Forma. Integrate your Forma instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Forma"
---

C1.ai provides identity governance for Forma. Integrate your Forma instance with C1.ai
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Forma connector is now pulling access data into C1.ai.
  </Tab>
