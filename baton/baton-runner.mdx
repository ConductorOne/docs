...
og:title: Baton-runner configuration reference - C1.ai docs
...
Download baton-runner from [dist.conductorone.com/C1.ai/baton-runner](https://dist.conductorone.com/ConductorOne/baton-runner). Builds are available for Windows (amd64), macOS (amd64 and arm64), and Linux (amd64 and arm64).
