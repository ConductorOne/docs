...
description: "C1.ai provides identity governance for Typeform. Integrate your Typeform account with C1.ai for unified visibility and governance over workspace access."
og:description: "C1.ai provides identity governance for Typeform. Integrate your Typeform account with C1.ai for unified visibility and governance over workspace access."
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Typeform connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and Typeform credentials as environment
        variables:
