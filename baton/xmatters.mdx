...
description: "C1.ai provides identity governance for xMatters. Integrate your xMatters instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for xMatters. Integrate your xMatters instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "xMatters"
---

C1.ai provides identity governance for xMatters. Integrate your xMatters
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your xMatters connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and xMatters credentials as environment
        variables:
