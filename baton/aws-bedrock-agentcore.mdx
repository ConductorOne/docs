...
description: "C1 provides identity governance for AWS Bedrock AgentCore. Integrate Bedrock AgentCore with C1 to manage non-human identities (AI agents), audit credential provider access, and track gateway associations."
og:description: "C1 provides identity governance for AWS Bedrock AgentCore. Integrate Bedrock AgentCore with C1 to manage non-human identities (AI agents), audit credential provider access, and track gateway associations."
...
- **Agents**: AI agents (workload identities), synced with the agent trait and classified as managed-identity non-human identities (NHIs).
