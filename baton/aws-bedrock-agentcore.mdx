...
description: "C1.ai provides identity governance for AWS Bedrock AgentCore. Integrate Bedrock AgentCore with C1.ai to manage non-human identities (AI agents), audit credential provider access, and track gateway associations."
og:description: "C1.ai provides identity governance for AWS Bedrock AgentCore. Integrate Bedrock AgentCore with C1.ai to manage non-human identities (AI agents), audit credential provider access, and track gateway associations."
...
- **`provision_oauth_credential`**: Create or update an AgentCore OAuth2 credential provider (e.g. from a C1.ai Personal Client Credential) and point an existing gateway target at it.
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **Done.** Your AWS Bedrock AgentCore connector is now pulling access data into C1.ai.
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1.ai, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the connector to. Data should be found on the **Entitlements**, **Accounts**, and **Secrets** tabs.
      </Step>
    </Steps>
