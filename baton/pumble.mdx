...
description: "C1.ai provides identity governance for Pumble. Integrate your Pumble instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Pumble. Integrate your Pumble instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Pumble"
---

C1.ai provides identity governance for Pumble. Integrate your Pumble
workspace with C1.ai for unified visibility and governance over who can access
your team chat.
...
remain visible in C1.ai rather than disappearing.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Pumble connector is now pulling access data into C1.ai.
  </Tab>
