...
description: "C1.ai provides identity governance and just-in-time provisioning for Boomi. Integrate your Boomi instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1.ai provides identity governance and just-in-time provisioning for Boomi. Integrate your Boomi instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
sidebarTitle: "Boomi"
---
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    <Steps>
      <Step>
        In C1.ai, navigate to **Admin** > **Connectors** and click **Add connector**.
      </Step>
    ...
    **Done.** Your Boomi connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    * [Official download center](https://dist.conductorone.com/ConductorOne/baton-boomi): For stable binaries (Windows/Linux/macOS) and container images.
    ...
    <Steps>
      <Step>
        In C1.ai, navigate to **Connectors** > **Add connector**.
      </Step>
    ...
    spec:
      ...
      template:
        ...
        spec:
          containers:
          - name: baton-boomi
            image: public.ecr.aws/conductorone/baton-boomi:latest
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1.ai, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the Boomi connector to. Boomi data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>
