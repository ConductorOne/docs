...
description: "C1 provides identity governance and just-in-time provisioning for Boomi. Integrate your Boomi instance with C1 to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1 provides identity governance and just-in-time provisioning for Boomi. Integrate your Boomi instance with C1 to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
sidebarTitle: "Boomi"
---
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **That's it!** Your Boomi connector is now pulling access data into C1.
  </Tab>
