...
| Invitations | <Icon icon="square-check" iconType="solid" color="#c937ae"/> | |
...
*Organization provisioning supports updating a user's role (user or admin). Removing a member from an organization is not supported by the VGS API.
