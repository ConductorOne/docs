...
description: "C1.ai provides identity governance for Codacy. Integrate your Codacy organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Codacy. Integrate your Codacy organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Codacy"
---

C1.ai provides identity governance for Codacy. Integrate your Codacy organization
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Codacy connector is now pulling access data into C1.ai.
  </Tab>
