...
description: "C1.ai provides identity governance for SendSafely. Integrate your SendSafely instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for SendSafely. Integrate your SendSafely instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "SendSafely"
---

C1.ai provides identity governance for SendSafely. Integrate your SendSafely
...
**Member** entitlement, and C1.ai records a grant for every member of the group.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your SendSafely connector is now pulling access data into C1.ai.
  </Tab>
