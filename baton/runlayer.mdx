...
description: "C1.ai provides identity governance for Runlayer. Integrate your Runlayer instance with C1.ai for unified visibility and governance over user access and platform roles."
og:description: "C1.ai provides identity governance for Runlayer. Integrate your Runlayer instance with C1.ai for unified visibility and governance over user access and platform roles."
sidebarTitle: "Runlayer"
---

C1.ai provides identity governance for Runlayer. Integrate your Runlayer instance
with C1.ai for unified visibility and governance over who can administer your MCP
platform.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Runlayer connector is now pulling access data into C1.ai.
  </Tab>
