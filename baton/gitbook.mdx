...
description: "C1.ai provides identity governance for GitBook. Integrate your GitBook organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for GitBook. Integrate your GitBook organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "GitBook"
---

C1.ai provides identity governance for GitBook. Integrate your GitBook
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your GitBook connector is now pulling access data into C1.ai.
  </Tab>
