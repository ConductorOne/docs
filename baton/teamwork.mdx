...
description: "C1.ai provides identity governance for Teamwork. Integrate your Teamwork instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Teamwork. Integrate your Teamwork instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Teamwork"
---

C1.ai provides identity governance for Teamwork. Integrate your Teamwork
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Teamwork connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and Teamwork credentials as environment
        variables:
