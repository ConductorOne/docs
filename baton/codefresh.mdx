...
description: "C1.ai provides identity governance for Codefresh. Integrate your Codefresh account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Codefresh. Integrate your Codefresh account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Codefresh"
---

{/* stargate: cf-codefresh-20260605 */}

C1.ai provides identity governance for Codefresh. Integrate your Codefresh account
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Codefresh connector is now pulling access data into C1.ai.
  </Tab>
