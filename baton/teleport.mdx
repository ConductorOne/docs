...
This connector only supports a self-hosted setup. **Follow these instructions to use the [Teleport](https://github.com/ConductorOne/baton-teleport) connector, hosted and run in your own environment.**
