...
description: "C1.ai provides identity governance for Stripe. Integrate your Stripe account with C1.ai for unified visibility and governance over team member access."
og:description: "C1.ai provides identity governance for Stripe. Integrate your Stripe account with C1.ai for unified visibility and governance over team member access."
sidebarTitle: "Stripe"
---

C1.ai provides identity governance for Stripe. Integrate your Stripe
account with C1.ai for unified visibility and governance over team member
access.
...
The connector reads and writes one Stripe account, the account the
SCIM token belongs to, through Stripe's SCIM 2.0 interface. It syncs
that account's team members and SCIM groups, and the membership of
each group. Team members deactivated through SCIM sync as disabled.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Stripe connector is now pulling access data into C1.ai.
  </Tab>
