...
description: "C1.ai provides identity governance for Mattermost. Integrate your Mattermost instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Mattermost. Integrate your Mattermost instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Mattermost"
---

C1.ai provides identity governance for Mattermost. Integrate your Mattermost
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Mattermost connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and Mattermost credentials as environment
        variables:
