...
description: "C1.ai provides identity governance for LogicMonitor. Integrate your LogicMonitor instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for LogicMonitor. Integrate your LogicMonitor instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "LogicMonitor"
---

C1.ai provides identity governance for LogicMonitor. Integrate your LogicMonitor
instance with C1.ai for unified visibility and governance over administrative and
privileged access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your LogicMonitor connector is now pulling access data into C1.ai.
  </Tab>
