...
description: "C1.ai provides identity governance for Mixpanel. Integrate your Mixpanel project with C1.ai for unified visibility and governance over who has access to your analytics data."
og:description: "C1.ai provides identity governance for Mixpanel. Integrate your Mixpanel project with C1.ai for unified visibility and governance over who has access to your analytics data."
sidebarTitle: "Mixpanel"
---

{/* stargate: cf-mixpanel-20260605 */}

C1.ai provides identity governance for Mixpanel. Integrate your Mixpanel project
with C1.ai for unified visibility and governance over who has access to your
analytics data.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Mixpanel connector is now pulling access data into C1.ai.
  </Tab>
