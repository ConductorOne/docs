...
description: "C1.ai provides identity governance for Matomo. Integrate your Matomo instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Matomo. Integrate your Matomo instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Matomo"
---

C1.ai provides identity governance for Matomo. Integrate your Matomo
instance with C1.ai for unified visibility and governance over which users
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Matomo connector is now pulling access data into C1.ai.
  </Tab>
