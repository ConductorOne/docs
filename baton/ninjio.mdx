...
description: "C1 provides identity governance for Ninjio. Integrate your Ninjio instance with C1 for unified visibility and governance over user access."
og:description: "C1 provides identity governance for Ninjio. Integrate your Ninjio instance with C1 for unified visibility and governance over user access."
sidebarTitle: "Ninjio"
---
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **Done.** Your Ninjio connector is now pulling access data into C1.
  </Tab>
