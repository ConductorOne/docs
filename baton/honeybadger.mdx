...
description: "C1.ai provides identity governance for Honeybadger. Integrate your Honeybadger instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Honeybadger. Integrate your Honeybadger instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Honeybadger"
---

C1.ai provides identity governance for Honeybadger. Integrate your Honeybadger
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Honeybadger connector is now pulling access data into C1.ai.
  </Tab>
