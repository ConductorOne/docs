...
description: "C1 provides identity governance and just-in-time provisioning for Atlassian. Integrate your Atlassian instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:title: "Set up an Atlassian connector"
og:description: "C1 provides identity governance and just-in-time provisioning for Atlassian. Integrate your Atlassian instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
