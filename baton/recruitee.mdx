...
description: "C1.ai provides identity governance for Recruitee. Integrate your Recruitee instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Recruitee. Integrate your Recruitee instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Recruitee"
---

{/* stargate */}

C1.ai provides identity governance for Recruitee. Integrate your Recruitee account
with C1.ai for unified visibility and governance over the admins who can access
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Recruitee connector is now pulling access data into C1.ai.
  </Tab>
