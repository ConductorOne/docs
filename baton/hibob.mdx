...
description: "C1.ai provides identity governance for HiBob. Integrate your HiBob instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for HiBob. Integrate your HiBob instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "HiBob"
---

C1.ai provides identity governance for HiBob. Integrate your HiBob instance with
C1.ai for unified visibility and governance over user access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your HiBob connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and HiBob credentials as environment
        variables:
