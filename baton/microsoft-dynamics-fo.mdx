...
description: "C1 provides identity governance and just-in-time provisioning for Microsoft Dynamics 365 - Finance & Operations. Integrate your Microsoft Dynamics 365 - Finance & Operations instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:description: "C1 provides identity governance and just-in-time provisioning for Microsoft Dynamics 365 - Finance & Operations. Integrate your Microsoft Dynamics 365 - Finance & Operations instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
...
**That's it!** Your Microsoft Dynamics 365 - Finance & Operations connector is now pulling access data into C1.
</Tab>
