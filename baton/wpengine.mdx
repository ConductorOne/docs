...
description: "C1.ai provides identity governance for WP Engine. Integrate your WP Engine instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for WP Engine. Integrate your WP Engine instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "WP Engine"
---

C1.ai provides identity governance for WP Engine. Integrate your WP Engine
portal with C1.ai for unified visibility and governance over which users have
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your WP Engine connector is now pulling access data into C1.ai.
  </Tab>
