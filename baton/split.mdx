...
description: "C1.ai provides identity governance for Split. Integrate your Split organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Split. Integrate your Split organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Split"
---

C1.ai provides identity governance for Split. Integrate your Split organization
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Split connector is now pulling access data into C1.ai.
  </Tab>
