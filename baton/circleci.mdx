...
description: "C1.ai provides identity governance for CircleCI. Integrate your CircleCI organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for CircleCI. Integrate your CircleCI organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "CircleCI"
---

{/* stargate: cf-circleci-20260605 */}

C1.ai provides identity governance for CircleCI. Integrate your CircleCI
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your CircleCI connector is now pulling access data into C1.ai.
  </Tab>
