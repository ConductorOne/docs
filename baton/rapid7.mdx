...
This connector works with Rapid7 products available on the Command Platform. Products that use a separate local API — such as the InsightVM console — are not supported.
