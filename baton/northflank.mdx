...
description: "C1.ai provides identity governance for Northflank. Integrate your Northflank organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Northflank. Integrate your Northflank organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Northflank"
---

C1.ai provides identity governance for Northflank. Integrate your Northflank
organization with C1.ai for unified visibility and governance over who has access
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Northflank connector is now pulling access data into C1.ai.
  </Tab>
