...
description: "C1.ai provides identity governance for GoCD. Integrate your GoCD server with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for GoCD. Integrate your GoCD server with C1.ai for unified visibility and governance over user access."
sidebarTitle: "GoCD"
---

{/* stargate: cf-gocd-20260605 */}

C1.ai provides identity governance for GoCD. Integrate your GoCD server with C1.ai for
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your GoCD connector is now pulling access data into C1.ai.
  </Tab>
