...
description: "C1.ai provides identity governance for SAP GRC. Integrate your SAP GRC instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for SAP GRC. Integrate your SAP GRC instance with C1.ai for unified visibility and governance over user access."
...
<Warning>
To complete this task, you need the **Connector Administrator** or **Super Administrator** role in C1.ai.
</Warning>
...
<Tabs>
  ...
  <Tab title="Self-hosted">
    ...
    spec:
      ...
      template:
        ...
        spec:
          containers:
          - name: baton-sap-grc
            image: public.ecr.aws/conductorone/baton-sap-grc:latest
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1.ai, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the SAP GRC connector to. SAP GRC data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>

    **Done.** Your SAP GRC connector is now pulling access data into C1.ai.
  </Tab>
</Tabs>