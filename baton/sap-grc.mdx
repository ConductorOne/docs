...
description: "C1 provides identity governance for SAP GRC. Integrate your SAP GRC instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:description: "C1 provides identity governance for SAP GRC. Integrate your SAP GRC instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
...
<Tabs>
  ...
  <Tab title="Self-hosted">
    ...
    **That's it!** Your SAP GRC connector is now pulling access data into C1.
  </Tab>
</Tabs>