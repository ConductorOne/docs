...
description: "C1.ai provides identity governance for Stytch. Integrate your Stytch instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Stytch. Integrate your Stytch instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Stytch"
---

C1.ai provides identity governance for Stytch. Integrate your Stytch B2B project
with C1.ai for unified visibility and governance over which Members belong to
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Stytch connector is now pulling access data into C1.ai.
  </Tab>
