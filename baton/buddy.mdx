...
description: "C1.ai provides identity governance for Buddy. Integrate your Buddy instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Buddy. Integrate your Buddy instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Buddy"
---

C1.ai provides identity governance for Buddy. Integrate your Buddy
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Buddy connector is now pulling access data into C1.ai.
  </Tab>
