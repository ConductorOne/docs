...
description: "C1.ai provides identity governance for Cisco Catalyst Center. Integrate your Catalyst Center instance with C1.ai for unified visibility and governance over administrator access."
og:description: "C1.ai provides identity governance for Cisco Catalyst Center. Integrate your Catalyst Center instance with C1.ai for unified visibility and governance over administrator access."
sidebarTitle: "Cisco Catalyst Center"
---

C1.ai provides identity governance for Cisco Catalyst Center (formerly DNA Center).
Integrate your Catalyst Center instance with C1.ai for unified visibility and
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Cisco Catalyst Center connector is now pulling access data into C1.ai.
  </Tab>
