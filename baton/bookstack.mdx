...
description: "C1.ai provides identity governance for Bookstack. Integrate your Bookstack instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Bookstack. Integrate your Bookstack instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Bookstack"
---

C1.ai provides identity governance for Bookstack. Integrate your Bookstack
instance with C1.ai for unified visibility and governance over who can access your
...
and a secret **Token Secret**. C1.ai takes these as a single value, joined with a
colon.
...
<Steps>
  ...
  <Step>
    ...
    string is the value C1.ai needs.
  </Step>
</Steps>
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Bookstack connector is now pulling access data into C1.ai.
  </Tab>
