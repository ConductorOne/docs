...
description: "C1.ai provides identity governance for Grammarly. Integrate your Grammarly institution with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Grammarly. Integrate your Grammarly institution with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Grammarly"
---

C1.ai provides identity governance for Grammarly. Integrate your Grammarly
institution with C1.ai for unified visibility and governance over user access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Grammarly connector is now pulling access data into C1.ai.
  </Tab>
