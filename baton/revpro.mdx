...
description: "C1.ai provides identity governance for Zuora RevPro. Integrate your Zuora tenant with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Zuora RevPro. Integrate your Zuora tenant with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Zuora RevPro"
---

C1.ai provides identity governance for Zuora RevPro (Zuora Revenue). Integrate
your Zuora tenant with C1.ai for unified visibility and governance over user
access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Zuora RevPro connector is now pulling access data into C1.ai.
  </Tab>
