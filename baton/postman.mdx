...
description: "C1.ai provides identity governance for Postman. Integrate your Postman instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Postman. Integrate your Postman instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Postman"
---

C1.ai provides identity governance for Postman. Integrate your Postman team
with C1.ai for unified visibility and governance over who belongs to which
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Postman connector is now pulling access data into C1.ai.
  </Tab>
