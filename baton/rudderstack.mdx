...
description: "C1.ai provides identity governance for RudderStack. Integrate your RudderStack organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for RudderStack. Integrate your RudderStack organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "RudderStack"
---

C1.ai provides identity governance for RudderStack. Integrate your RudderStack
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your RudderStack connector is now pulling access data into C1.ai.
  </Tab>
