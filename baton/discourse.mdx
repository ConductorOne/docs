...
description: "C1.ai provides identity governance for Discourse. Integrate your Discourse instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Discourse. Integrate your Discourse instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Discourse"
---

C1.ai provides identity governance for Discourse. Integrate your Discourse
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Discourse connector is now pulling access data into C1.ai.
  </Tab>
