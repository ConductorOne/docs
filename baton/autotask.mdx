...
description: "C1.ai provides identity governance for Autotask. Integrate your Autotask instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Autotask. Integrate your Autotask instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Autotask"
---

C1.ai provides identity governance for Autotask PSA (by Datto/Kaseya). Integrate
your Autotask instance with C1.ai for unified visibility and governance over
...
creates Autotask `Tickets` records for C1.ai provisioning tasks.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    <Steps>
      ...
      <Step>
        **Optional.** If you want C1.ai to create Autotask tickets for manual
    ...
    **Done.** Your Autotask connector is now pulling access data into C1.ai.
  </Tab>
...
as an external ticketing provider in C1.ai.

<Steps>
  <Step>
    In C1.ai, navigate to **Platform** > **External ticketing**.
  </Step>
...
- **Ticket creation.** External ticket provisioning creates Autotask `Tickets`
  records. The connector does not update or close Autotask tickets directly; C1.ai
