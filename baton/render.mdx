...
description: "C1.ai provides identity governance for Render. Integrate your Render workspace with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Render. Integrate your Render workspace with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Render"
---

C1.ai provides identity governance for Render. Integrate your Render workspace
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Render connector is now pulling access data into C1.ai.
  </Tab>
