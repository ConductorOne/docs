...
<Steps>
	...
	**"Condition": "sts:ExternalId"**: This adds an extra layer of security by requiring a specific External ID. Only requests that include this exact External ID can assume the role, preventing unauthorized access even if the role ARN is known.
    </Step>
    <Step>
    Click **Next**.
    </Step>
