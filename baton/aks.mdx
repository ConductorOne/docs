...
description: "C1 provides identity governance for Azure Kubernetes Service. Integrate your Azure Kubernetes Service instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:description: "C1 provides identity governance for Azure Kubernetes Service. Integrate your Azure Kubernetes Service instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
...
**That's it!** Your Azure Kubernetes Service connector is now pulling access data into C1.
...
<Step>
Check that the connector data uploaded correctly. In ConductorOne, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the Azure Kubernetes Service connector to. Azure Kubernetes Service data should be found on the **Entitlements** and **Accounts** tabs.
</Step>
</Steps>
