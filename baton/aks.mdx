...
description: "C1 provides identity governance for Azure Kubernetes Service (AKS). Integrate your AKS instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:description: "C1 provides identity governance for Azure Kubernetes Service (AKS). Integrate your AKS instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
