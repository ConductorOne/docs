...
description: "C1.ai provides identity governance for Casdoor. Integrate your Casdoor instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Casdoor. Integrate your Casdoor instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Casdoor"
---

C1.ai provides identity governance for Casdoor. Integrate your Casdoor
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Casdoor connector is now pulling access data into C1.ai.
  </Tab>
