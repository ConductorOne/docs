...
description: "C1.ai provides identity governance for Paycom. Integrate your Paycom instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Paycom. Integrate your Paycom instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Paycom"
---

C1.ai provides identity governance for Paycom. Integrate your Paycom
instance with C1.ai for unified visibility and governance over employee access.

The Paycom connector is read-only: it syncs employees as identities. Paycom's
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Paycom connector is now pulling access data into C1.ai.
  </Tab>
