...
description: "C1.ai provides identity governance for Intercom. Integrate your Intercom workspace with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Intercom. Integrate your Intercom workspace with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Intercom"
---

{/* stargate */}

C1.ai provides identity governance for Intercom. Integrate your Intercom workspace
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Intercom connector is now pulling access data into C1.ai.
  </Tab>
