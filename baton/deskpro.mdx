...
description: "C1.ai provides identity governance for Deskpro. Integrate your Deskpro instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Deskpro. Integrate your Deskpro instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Deskpro"
---

C1.ai provides identity governance for Deskpro. Integrate your Deskpro
instance with C1.ai for unified visibility and governance over agent access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Deskpro connector is now pulling access data into C1.ai.
  </Tab>
