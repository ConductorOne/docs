...
description: "C1.ai provides identity governance for PropelAuth. Integrate your PropelAuth environment with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for PropelAuth. Integrate your PropelAuth environment with C1.ai for unified visibility and governance over user access."
sidebarTitle: "PropelAuth"
---

C1.ai provides identity governance for PropelAuth. Integrate your PropelAuth
environment with C1.ai for unified visibility and governance over the users in
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your PropelAuth connector is now pulling access data into C1.ai.
  </Tab>
