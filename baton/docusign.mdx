...
- **Cloud-hosted (production)**: You'll use ConductorOne's managed OAuth app. No additional credentials are needed. You can **skip this section** and go straight to the cloud-hosted setup instructions below.
...
<Steps>
  ...
  Choose your **authentication method**:
    - **OAuth Authentication** (default) — connects to DocuSign's production environment using ConductorOne's managed OAuth app. No additional credentials required.
...
<Steps>
  ...
  <Step>
  Check that the connector data uploaded correctly. In ConductorOne, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the Docusign connector to. Docusign data should be found on the **Entitlements** and **Accounts** tabs.
  </Step>
</Steps>
