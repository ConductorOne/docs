...
description: "C1.ai provides identity governance for Cisco Webex. Integrate your Cisco Webex organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Cisco Webex. Integrate your Cisco Webex organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Cisco Webex"
---

C1.ai provides identity governance for Cisco Webex. Integrate your Cisco Webex
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Cisco Webex connector is now pulling access data into C1.ai.
  </Tab>
