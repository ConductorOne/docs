...
description: "C1.ai provides identity governance for Clerk. Integrate your Clerk instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Clerk. Integrate your Clerk instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Clerk"
---
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Clerk connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and the Clerk Secret Key as environment
        variables:
