...
description: "C1.ai provides identity governance for Aha!. Integrate your Aha! account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Aha!. Integrate your Aha! account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Aha!"
---

C1.ai provides identity governance for Aha!. Integrate your Aha! account with C1.ai
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Aha! connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and Aha! credentials as environment variables:
