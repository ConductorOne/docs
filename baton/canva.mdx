...
description: "C1.ai provides identity governance and just-in-time provisioning for Canva. Integrate your Canva tenant with C1.ai to run user access reviews, enable access requests, and provision accounts and group memberships."
og:description: "C1.ai provides identity governance and just-in-time provisioning for Canva. Integrate your Canva tenant with C1.ai to run user access reviews, enable access requests, and provision accounts and group memberships."
sidebarTitle: "Canva"
---
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **Done.** Your Canva connector is now pulling access data into C1.ai.
  </Tab>
