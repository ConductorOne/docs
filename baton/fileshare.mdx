...
description: C1 provides identity governance for Windows file shares. Integrate your file share NTFS permissions with ConductorOne to run user access reviews (UARs) and gain visibility into shared folder access.
