...
<Tip>
**A newer version of this connector is available.** This version of the connector is no longer available for installation. If you're setting up Azure connector with C1 for the first time, go to [Azure](/baton/azure). 
</Tip>
