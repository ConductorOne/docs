...
og:title: Set up a Ramp connector - ConductorOne docs
...
description: ConductorOne provides identity governance for Ramp. Integrate your Ramp instance with ConductorOne to run user access reviews (UARs) and enable just-in-time access requests.
sidebarTitle: Ramp
---
...
**Follow these instructions to use the [Ramp](https://github.com/ConductorOne/baton-ramp) connector, hosted and run in your own environment.**
...
<Step>
Check that the connector data uploaded correctly. In ConductorOne, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the Ramp connector to. Ramp data should be found on the **Entitlements** and **Accounts** tabs.
</Step>
</Steps>
