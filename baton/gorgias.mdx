...
description: "C1.ai provides identity governance for Gorgias. Integrate your Gorgias instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Gorgias. Integrate your Gorgias instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Gorgias"
---

C1.ai provides identity governance for Gorgias. Integrate your Gorgias account
with C1.ai for unified visibility and governance over agent access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Gorgias connector is now pulling access data into C1.ai.
  </Tab>
