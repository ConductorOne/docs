...
description: "C1.ai provides identity governance for Rocket.Chat. Integrate your Rocket.Chat workspace with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Rocket.Chat. Integrate your Rocket.Chat workspace with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Rocket.Chat"
---

C1.ai provides identity governance for Rocket.Chat. Integrate your Rocket.Chat
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Rocket.Chat connector is now pulling access data into C1.ai.
  </Tab>
