...
description: "C1.ai provides identity governance for Mural. Integrate your Mural workspace with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Mural. Integrate your Mural workspace with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Mural"
---

C1.ai provides identity governance for Mural. Integrate your Mural
workspace with C1.ai for unified visibility and governance over user access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Mural connector is now pulling access data into C1.ai.
  </Tab>
