...
description: "C1 provides identity governance for Google Kubernetes Engine (GKE). Integrate your GKE cluster with ConductorOne to run user access reviews (UARs) and manage Kubernetes RBAC roles and the GCP IAM role bindings on the cluster's project."
og:description: "C1 provides identity governance for Google Kubernetes Engine (GKE). Integrate your GKE cluster with ConductorOne to run user access reviews (UARs) and manage Kubernetes RBAC roles and the GCP IAM role bindings on the cluster's project."
