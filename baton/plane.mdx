...
description: "C1.ai provides identity governance for Plane. Integrate your Plane instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Plane. Integrate your Plane instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Plane"
---

C1.ai provides identity governance for Plane. Integrate your Plane workspace with
C1.ai for unified visibility and governance over who can access your workspace and
projects.
...
to, so make sure you note the slug of the specific workspace you want C1.ai to
sync.
</Warning>
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Plane connector is now pulling access data into C1.ai.
  </Tab>
