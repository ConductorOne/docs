...
description: "C1.ai provides identity governance for Wiz. Integrate your Wiz instance with C1.ai to run user access reviews (UARs) and gain visibility into cloud security access."
og:description: "C1.ai provides identity governance for Wiz. Integrate your Wiz instance with C1.ai to run user access reviews (UARs) and gain visibility into cloud security access."
sidebarTitle: "Wiz"
---
...
There is also a [Wiz Insights connector](https://www.conductorone.com/docs/baton/wiz-insights) that syncs security issues from Wiz as [external insights](https://www.conductorone.com/docs/product/admin/external-insights), surfacing identity risk scores alongside access decisions in C1.ai.
</Tip>
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **Done.** Your Wiz connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    spec:
      ...
      template:
        ...
        spec:
          containers:
          - name: baton-wiz-win
            image: public.ecr.aws/conductorone/baton-wiz-win:latest
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1.ai, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the Wiz connector to. Wiz data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>
