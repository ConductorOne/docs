...
description: "C1.ai provides identity governance for Alibaba Cloud. Integrate your Alibaba Cloud instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Alibaba Cloud. Integrate your Alibaba Cloud instance with C1.ai for unified visibility and governance over user access."
...
- Group membership is the only access this connector syncs. The account, user,
  ...
  declare that in their capability metadata, so C1.ai does not enumerate
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Alibaba Cloud connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and Alibaba Cloud credentials as environment
        variables:
