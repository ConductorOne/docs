...
description: "C1.ai provides identity governance for npm. Integrate your npm organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for npm. Integrate your npm organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "npm"
---

C1.ai provides identity governance for npm. Integrate your npm organization with C1.ai
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your npm connector is now pulling access data into C1.ai.
  </Tab>
