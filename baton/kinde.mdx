...
description: "C1.ai provides identity governance for Kinde. Integrate your Kinde tenant with C1.ai for unified visibility and governance over users and organization membership."
og:description: "C1.ai provides identity governance for Kinde. Integrate your Kinde tenant with C1.ai for unified visibility and governance over users and organization membership."
sidebarTitle: "Kinde"
---

C1.ai provides identity governance for Kinde. Integrate your Kinde tenant with
C1.ai for unified visibility and governance over users and their membership
in organizations.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Kinde connector is now pulling access data into C1.ai.
  </Tab>
