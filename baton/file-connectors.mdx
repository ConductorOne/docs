...
<Columns cols={2}>
<Card title="Identity-focused template" icon="user" href="/C1IdentityDataTemplate.xlsx">
Use this template if your data is organized by accounts or users.
</Card>

<Card title="Entitlement-focused template" icon="shield-check" href="/C1EntitlementDataTemplate.xlsx">
...
<a href="/C1IdentityDataTemplate.xlsx" download>C1IdentityDataTemplate.xlsx>Use this template if your data is organized by accounts or users.</a>>

<a href="/C1EntitlementDataTemplate.xlsx" download>C1EntitlementDataTemplate.xlsx>Use this template if your data is organized by entitlements or permissions.</a>>

Version 2

<a href="/public/C1IdentityDataTemplate.xlsx" download>C1IdentityDataTemplate.xlsx>Use this template if your data is organized by accounts or users.</a>>

<a href="/public/C1EntitlementDataTemplate.xlsx" download>C1EntitlementDataTemplate.xlsx>Use this template if your data is organized by entitlements or permissions.</a>>
