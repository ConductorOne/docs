...
ConductorOne allows for custom configurations in your Excel or CSV file, as each file can be dynamically mapped into different data elements in C1, such as username, email, or manager.
