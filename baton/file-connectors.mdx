...
ConductorOne will now begin ingesting the data into the C1 application. To review the detected delta between files, click **View logs** on the connector.
...
To ensure that the data in your spreadsheet maps accurately into ConductorOne’s system, map your spreadsheet’s values to those used by C1.
