...
<Columns cols={2}>
<Card title="Identity-focused template" icon="user" href="/public/C1IdentityDataTemplate.xlsx">
Use this template if your data is organized by accounts or users.
</Card>

<Card title="Entitlement-focused template" icon="shield-check" href="/public/C1EntitlementDataTemplate.xlsx">
