...
description: "C1 provides identity governance and security posture visibility for Wiz. Integrate your Wiz instance with ConductorOne to sync security insights related to user and service accounts, enabling identity-aware cloud security posture visibility."
og:description: "C1 provides identity governance and security posture visibility for Wiz. Integrate your Wiz instance with ConductorOne to sync security insights related to user and service accounts, enabling identity-aware cloud security posture visibility."
