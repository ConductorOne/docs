...
| Invitation | <Icon icon="square-check" iconType="solid"  color="#65DE23"/> | <Icon icon="square-check" iconType="solid"  color="#65DE23"/> |
| Organization | <Icon icon="square-check" iconType="solid"  color="#65DE23"/> | <Icon icon="square-check" iconType="solid"  color="#65DE23"/> |
...
| Service account | <Icon icon="square-check" iconType="solid"  color="#65DE23"/> | (delete only) |
