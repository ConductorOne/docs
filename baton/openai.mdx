...
| Service account | <Icon icon="square-check" iconType="solid"  color="#c937ae"/> | (delete only) |
...
The ConductorOne OpenAI connector uses the Admin API to manage project memberships. When you configure C1 to provision access to OpenAI projects, ConductorOne handles these API calls for you, filling the gap that SCIM leaves for project-level access.
