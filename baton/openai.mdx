...
- OpenAI Admin Key (must be an "Admin" type key with organization management permissions)

See the OpenAI docs for information on how to acquire credentials: [View the documentation](https://platform.openai.com/docs/api-reference/admin-api-keys)
