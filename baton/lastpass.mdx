...
description: "C1 provides identity governance for LastPass. Integrate your LastPass instance with C1 for unified visibility and governance over user access."
og:description: "C1 provides identity governance for LastPass. Integrate your LastPass instance with C1 for unified visibility and governance over user access."
...
**Done.** Your LastPass connector is now pulling access data into C1.
</Tab>
