---
title: "Set up LastPass connector"
og:title: "Set up LastPass connector"
description: "C1.ai provides identity governance for LastPass. Integrate your LastPass instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for LastPass. Integrate your LastPass instance with C1.ai for unified visibility and governance over user access."
...
| Shared Folder | <Icon icon="square-check" iconType="solid"  color="#c937ae"/> |  |
...
**Done.** Your LastPass connector is now pulling access data into C1.ai.
</Tab>
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: baton-lastpass
        image: public.ecr.aws/conductorone/baton-lastpass:latest
...
<Step>
Check that the connector data uploaded correctly. In C1.ai, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the lastpass connector to. lastpass data should be found on the **Entitlements** and **Accounts** tabs.
</Step>
</Steps>
