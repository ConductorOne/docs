...
description: "C1.ai provides identity governance for Xurrent (formerly Zenduty). Integrate your Xurrent account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Xurrent (formerly Zenduty). Integrate your Xurrent account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Xurrent"
---

C1.ai provides identity governance for Xurrent. Integrate your Xurrent
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Xurrent connector is now pulling access data into C1.ai.
  </Tab>
