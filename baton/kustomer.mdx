...
description: "C1.ai provides identity governance for Kustomer. Integrate your Kustomer instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Kustomer. Integrate your Kustomer instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Kustomer"
---

C1.ai provides identity governance for Kustomer. Integrate your Kustomer
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Kustomer connector is now pulling access data into C1.ai.
  </Tab>
