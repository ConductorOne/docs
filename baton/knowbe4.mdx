...
description: "C1.ai provides identity governance for KnowBe4. Integrate your KnowBe4 instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for KnowBe4. Integrate your KnowBe4 instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "KnowBe4"
---

C1.ai provides identity governance for KnowBe4. Integrate your KnowBe4 instance
with C1.ai for unified visibility and governance over group membership.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your KnowBe4 connector is now pulling access data into C1.ai.
  </Tab>
