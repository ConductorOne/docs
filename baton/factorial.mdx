...
description: "C1.ai provides identity governance for Factorial. Integrate your Factorial instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Factorial. Integrate your Factorial instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Factorial"
---

C1.ai provides identity governance for Factorial. Integrate your Factorial
instance with C1.ai for unified visibility and governance over employee access to
departments.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Factorial connector is now pulling access data into C1.ai.
  </Tab>
