...
description: "C1.ai provides identity governance for Kaseya Spanning Backup for Office 365. Integrate your Spanning tenant with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Kaseya Spanning Backup for Office 365. Integrate your Spanning tenant with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Spanning"
---

C1.ai provides identity governance for Kaseya Spanning Backup for Office 365.
Integrate your Spanning tenant with C1.ai for unified visibility and governance
over user access.
...
- **Users**: Spanning users from the tenant, mapped as C1.ai users. Each user
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Spanning connector is now pulling access data into C1.ai.
  </Tab>
