...
description: "C1.ai provides identity governance for Mailchimp. Integrate your Mailchimp account with C1.ai for unified visibility and governance over who owns the connection."
og:description: "C1.ai provides identity governance for Mailchimp. Integrate your Mailchimp account with C1.ai for unified visibility and governance over who owns the connection."
sidebarTitle: "Mailchimp"
---

{/* stargate: cf-mailchimp-20260605 */}

C1.ai provides identity governance for Mailchimp. Integrate your Mailchimp account
with C1.ai for unified visibility and governance over the account behind the
connection.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Mailchimp connector is now pulling access data into C1.ai.
  </Tab>
