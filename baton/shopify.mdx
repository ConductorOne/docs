...
description: "C1.ai provides identity governance for Shopify. Integrate your Shopify store with C1.ai for unified visibility and governance over staff user access."
og:description: "C1.ai provides identity governance for Shopify. Integrate your Shopify store with C1.ai for unified visibility and governance over staff user access."
sidebarTitle: "Shopify"
---

C1.ai provides identity governance for Shopify. Integrate your Shopify store
with C1.ai for unified visibility and governance over staff user access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    Follow these instructions to use a built-in connector hosted by C1.ai.
    ...
    **Done.** Your Shopify connector is now pulling access data into C1.ai.
  </Tab>
