...
description: "C1 provides identity governance and just-in-time provisioning for ADP Workforce Now. Integrate your ADP Workforce Now instance with C1 to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1 provides identity governance and just-in-time provisioning for ADP Workforce Now. Integrate your ADP Workforce Now instance with C1 to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **That's it!** Your ADP Workforce Now connector is now pulling access data into C1.
  </Tab>
