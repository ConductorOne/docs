...
| :------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| User     | <Icon icon="square-check" iconType="solid" color="#c937ae"/> | <Icon icon="square-xmark" iconType="solid" color="#DE2323"/> |
| Group    | <Icon icon="square-check" iconType="solid" color="#c937ae"/> | <Icon icon="square-xmark" iconType="solid" color="#DE2323"/> |
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **That's it!** Your Sap Cloud Identity connector is now pulling access data into C1.
