...
description: "C1.ai provides identity governance for Document360. Integrate your Document360 instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Document360. Integrate your Document360 instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Document360"
---

C1.ai provides identity governance for Document360. Integrate your Document360
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Document360 connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and Document360 credentials as environment
        variables:
