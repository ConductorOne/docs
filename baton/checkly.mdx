...
description: "C1.ai provides identity governance for Checkly. Integrate your Checkly account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Checkly. Integrate your Checkly account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Checkly"
---

C1.ai provides identity governance for Checkly. Integrate your Checkly account
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Checkly connector is now pulling access data into C1.ai.
  </Tab>
