...
description: "C1.ai provides identity governance for PostHog. Integrate your PostHog organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for PostHog. Integrate your PostHog organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "PostHog"
---

C1.ai provides identity governance for PostHog. Integrate your PostHog
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your PostHog connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and PostHog credentials as environment
        variables:
