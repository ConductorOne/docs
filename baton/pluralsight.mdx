...
description: "C1.ai provides identity governance for Pluralsight. Integrate your Pluralsight account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Pluralsight. Integrate your Pluralsight account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Pluralsight"
---

C1.ai provides identity governance for Pluralsight. Integrate your Pluralsight
account with C1.ai for unified visibility and governance over users and team
membership.
...
- **Users**: the account's Pluralsight users, mapped as C1.ai users. Each user
  carries `id` (stable external id), `email`, and name.
- **Teams**: Pluralsight teams, mapped as C1.ai groups. Each team exposes a
