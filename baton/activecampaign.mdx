...
description: "C1.ai provides identity governance for ActiveCampaign. Integrate your ActiveCampaign account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for ActiveCampaign. Integrate your ActiveCampaign account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "ActiveCampaign"
---

C1.ai provides identity governance for ActiveCampaign. Integrate your
ActiveCampaign account with C1.ai for unified visibility and governance over your
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your ActiveCampaign connector is now pulling access data into C1.ai.
  </Tab>
