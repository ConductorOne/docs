...
description: "C1.ai provides read-only identity governance for Fortinet FortiManager management administrator accounts and admin profiles."
og:description: "C1.ai provides read-only identity governance for Fortinet FortiManager management administrator accounts and admin profiles."
sidebarTitle: "Fortinet FortiManager"
---

C1.ai provides read-only identity governance for Fortinet FortiManager. Integrate
your FortiManager instance with C1.ai for unified visibility over privileged
...
`Authorization: Bearer` header and stores it as a masked secret in C1.ai.
...
<Steps>
  <Step title="Create an API user">
    ...
    Access)** enabled and Trusted Hosts restricted to the C1.ai egress range.
  </Step>
