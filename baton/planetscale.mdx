...
description: "C1.ai provides identity governance for PlanetScale. Integrate your PlanetScale organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for PlanetScale. Integrate your PlanetScale organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "PlanetScale"
---

C1.ai provides identity governance for PlanetScale. Integrate your PlanetScale
...
<Steps>
  ...
  <Step>
    ...
    organizations you want C1.ai to govern.
  </Step>
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your PlanetScale connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and PlanetScale credentials as environment
        variables:
