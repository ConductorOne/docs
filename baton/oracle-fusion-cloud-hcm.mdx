...
description: "C1.ai provides identity governance for Oracle Fusion Cloud HCM. Integrate your Oracle Fusion Cloud HCM instance with C1.ai to run user access reviews (UARs) and enable just-in-time access requests."
og:description: "C1.ai provides identity governance for Oracle Fusion Cloud HCM. Integrate your Oracle Fusion Cloud HCM instance with C1.ai to run user access reviews (UARs) and enable just-in-time access requests."
...
**Done.** Your Oracle Fusion Cloud HCM connector is now pulling access data into C1.ai.
</Tab>
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: baton-oracle-fusion-cloud-hcm
        image: public.ecr.aws/conductorone/baton-oracle-fusion-cloud-hcm:latest
...
<Step>
Check that the connector data uploaded correctly. In C1.ai, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the Oracle Fusion Cloud HCM connector to. Oracle Fusion Cloud HCM data should be found on the **Entitlements** and **Accounts** tabs.
</Step>
</Steps>
