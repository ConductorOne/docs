...
og:title: Set up Google Workspace connector - C1.ai docs
og:description: Integrate your Google Workspace instance with C1.ai to run user access reviews, enable just-in-time access requests, and easily provision and deprovision access.
description: C1.ai provides identity governance and just-in-time provisioning for Google Workspace. Integrate your Google Workspace instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access.
sidebarTitle: Google Workspace
---

<Tip>
**A newer version of this connector is available.** If you're setting up a Google Workspace connector with C1.ai for the first time, use the [v2 version](/baton/google-workspace). 
</Tip>

## Availability

<Icon icon="square-check" iconType="solid"  color="#c937ae"/> **General availability.** The Google Workspace connector is available to all C1.ai users.

## Capabilities

- Sync user identities from Google Workspace to C1.ai
...
<Steps>
<Step>
In C1.ai, navigate to **Apps** > **Connectors** > **Google Workspace**.
</Step>
<Step>
...
- **If you are the integration owner**, proceed to [Integrate your Google Workspace instance](/baton/v1/google-workspace#integrate-your-google-workspace-instance) for instructions on integrating Google Workspace with C1.ai.
...
<Warning>
A user with the **Connector Administrator** or **Super Administrator** role in C1.ai and **Super Admin** role in Google Workspace must perform this task.
</Warning>
...
Create a new project for your organization:
   ...
   - **Project Name**: Choose a names, cush as "C1.ai Integration"
...
### Step 7: Add your Google Workspace credentials to C1.ai
