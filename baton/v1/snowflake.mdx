...
description: "Integrate your Snowflake instance with C1.ai to run user access reviews, enable just-in-time access requests, and easily provision and deprovision access."
...
<Tip>
**A newer version of this connector is available.** This version of the connector is no longer available for installation. If you're setting up a Snowflake connector with C1.ai for the first time, use the [v2 version](/baton/snowflake).
</Tip>

## Capabilities

- Sync user identities from Snowflake to C1.ai
...
Proceed to [Configure your Snowflake connector](/baton/v1/snowflake#configure-your-snowflake-connector) for instructions on integrating Snowflake with C1.ai.

## Configure your Snowflake connector

<Warning>
A user with the **Connector Administrator** or **Super Administrator** role in C1.ai and **Manage Grants** global privilege in Snowflake must perform this task.
</Warning>
...
<Step>
Locate the account you wish to connect to C1.ai in the accounts list.
</Step>
...
### Step 2: Add your Snowflake credentials to C1.ai

<Steps>
<Step>
In C1.ai, navigate to the Snowflake connector by either:
...
<Step>
Return to C1.ai. After you see the **Connector updated** message, click on **View logs** to verify that the connector syncs successfully.
</Step>
</Steps>
