...
<Tip>
**A newer version of this connector is available.** This version of the connector is no longer available for installation. If you're setting up a OneLogin connector with ConductorOne for the first time, use the [v2 version](/baton/onelogin-v2).
</Tip>
