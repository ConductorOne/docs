...
<Steps>
<Step>
In C1, navigate to **Apps** > **Connectors**.
</Step>
<Step>
...
Proceed to [Integrate your Azure AD instance](/baton/v1/azure#integrate-your-azure-ad-instance) for instructions on integrating Azure AD with C1.
