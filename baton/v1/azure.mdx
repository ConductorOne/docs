...
<Tip>
*A newer version of this connector is available.** Azure Active Directory is now Microsoft Entra ID. If you're setting up this integration for the first time, go to [Entra ID integration](/baton/entra) to get started.  
</Tip>
