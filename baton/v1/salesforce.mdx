...
<Tip>
 **A newer version of this connector is available.** This version of the connector is no longer available for installation. If you're setting up a Salesforce connector with ConductorOne for the first time, use the [v2 version](/baton/salesforce-v2).
</Tip>
...
If you see this message, follow the instructions in [Step 0: Enable API access for your Salesforce user](/baton/salesforce-v2#step-0-enable-api-access-for-your-salesforce-user) and then try logging in again.
