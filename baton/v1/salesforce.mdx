...
If you see this message, follow the instructions in [Step 0: Enable API access for your Salesforce user](/baton/salesforce#step-0-enable-api-access-for-your-salesforce-user) and then try logging in again.
