...
description: "Integrate your Ramp instance with C1.ai to run user access reviews, enable just-in-time access requests, and easily provision and deprovision access."
og:description: "Integrate your Ramp instance with C1.ai to run user access reviews, enable just-in-time access requests, and easily provision and deprovision access."
sidebarTitle: "Ramp (v1)"
---

<Tip>
**A newer version of this connector is available.** This version of the connector is no longer available for installation. If you're setting up a Ramp connector with C1.ai for the first time, use the [v2 version](/baton/ramp).
</Tip>
...
<Step>
Log in and authorize C1.ai with your Ramp instance.
</Step>

<Step>
You will then be redirected back to the Ramp setup page in C1.ai, where you'll see an authorization message.
</Step>
