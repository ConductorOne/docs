...
<Tip>
**A newer version of this connector is available.** If you're setting up a Google Cloud connector with ConductorOne for the first time, use [Google Cloud Platform with Google Workspace](/baton/google-cloud-platform). 
</Tip>
