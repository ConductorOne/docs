...
og:title: "Set up AWS connector - C1 docs"
og:description: Integrate your AWS instance with C1 to run user access reviews, enable just-in-time (JIT) access requests, and easily provision and deprovision access.
...
Give the role a name, such as **C1Integration**.
   ...
   <Frame><img src="/images/product/assets/AWS-3.png" alt="Detail view of the C1Integration role, with the Role ARN copy function shown displaying ARN Copied."/></Frame>
</Step>
<Step>
...
<Frame><img src="/images/product/assets/AWS-5.png" alt="Detail view of the C1Integration role, with the Role ARN copy function shown displaying ARN Copied."/></Frame>
</Step>
<Step>
...
<Frame><img src="/images/product/assets/AWS-7.png" alt="Detail view of the C1Permissions policy, with the Policy ARN copy function shown displaying ARN Copied."/></Frame>
</Step>
<Step>
...
<Frame><img src="/images/product/assets/AWS-8.png" alt="Detail view of the C1Integration role, with the Role ARN copy function shown displaying ARN Copied."/></Frame>
</Step>
</Steps>
