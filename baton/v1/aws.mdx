...
<Tip>
**A newer version of this connector is available.** If you're setting up an AWS connector with ConductorOne for the first time, use the [v2 version](/baton/aws). 
</Tip>
