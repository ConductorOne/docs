...
og:title: Set up a Docusign connector - C1 docs
og:description: Integrate your Docusign instance with C1 to run user access reviews, enable just-in-time access requests, and easily provision and deprovision access.
...
<Tip>
**A newer version of this connector is available.** This version of the connector is no longer available for installation. If you're setting up a Docusign connector with ConductorOne for the first time, use the [v2 version](/baton/docusign). 
</Tip>
...
<Warning>
To complete this task, you'll need the **Connector Administrator** or **Super Administrator** role in C1.
</Warning>
