...
You can rename a connector to make it easier to identify in your C1.ai instance.

<Steps>
    <Step>
    Navigate to **Apps** > **Connectors** and select a connector.
    </Step>
    <Step>
...
<Steps>
    ...
    <Step>
    Select one or more users from the list of C1.ai users.
    </Step>
    <Step>
    Click **Save**.
    </Step>
