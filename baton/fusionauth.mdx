...
description: "C1.ai provides identity governance for FusionAuth. Integrate your FusionAuth instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for FusionAuth. Integrate your FusionAuth instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "FusionAuth"
---

C1.ai provides identity governance for FusionAuth. Integrate your FusionAuth
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your FusionAuth connector is now pulling access data into C1.ai.
  </Tab>
