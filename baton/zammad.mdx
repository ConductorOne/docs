...
description: "C1.ai provides identity governance for Zammad. Integrate your Zammad instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Zammad. Integrate your Zammad instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Zammad"
---

C1.ai provides identity governance for Zammad. Integrate your Zammad instance
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Zammad connector is now pulling access data into C1.ai.
  </Tab>
