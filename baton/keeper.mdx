...
description: "C1.ai provides identity governance for Keeper. Integrate your Keeper instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Keeper. Integrate your Keeper instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Keeper"
---

C1.ai provides identity governance for Keeper. Integrate your Keeper instance with
C1.ai for unified visibility and governance over team membership.
...
<Steps>
  <Step>
    ...
    and select the node you want C1.ai to sync.
  </Step>
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Keeper connector is now pulling access data into C1.ai.
  </Tab>
