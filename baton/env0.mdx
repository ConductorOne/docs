...
description: "C1.ai provides identity governance for env0. Integrate your env0 organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for env0. Integrate your env0 organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "env0"
---

{/* stargate: cf-env0-20260605 */}

C1.ai provides identity governance for env0. Integrate your env0 organization with
C1.ai for unified visibility and governance over who belongs to your env0
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your env0 connector is now pulling access data into C1.ai.
  </Tab>
