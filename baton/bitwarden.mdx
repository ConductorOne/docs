...
description: "C1.ai provides identity governance for Bitwarden. Integrate your Bitwarden organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Bitwarden. Integrate your Bitwarden organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Bitwarden"
---

{/* stargate: cf-bitwarden-fullimpl-20260605 */}

C1.ai provides identity governance for Bitwarden. Integrate your Bitwarden
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Bitwarden connector is now pulling access data into C1.ai.
  </Tab>
