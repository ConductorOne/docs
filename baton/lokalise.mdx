...
description: "C1.ai provides identity governance for Lokalise. Integrate your Lokalise teams with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Lokalise. Integrate your Lokalise teams with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Lokalise"
---

C1.ai provides identity governance for Lokalise. Integrate your Lokalise
teams with C1.ai for unified visibility and governance over user access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Lokalise connector is now pulling access data into C1.ai.
  </Tab>
