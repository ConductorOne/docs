...
description: "C1.ai provides identity governance for Chatwoot. Integrate your Chatwoot instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Chatwoot. Integrate your Chatwoot instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Chatwoot"
---

C1.ai provides identity governance for Chatwoot. Integrate your Chatwoot
instance with C1.ai for unified visibility and governance over agent access to
teams.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Chatwoot connector is now pulling access data into C1.ai.
  </Tab>
