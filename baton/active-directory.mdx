...
<Steps>
  ...
  <Step>
    Next to the **Not Connected** label, click on the word **Baton** to navigate to the application page. Click the pencil icon at the top of the page and rename the application to **Active Directory**. This updates the application name and icon. To rename the connector itself, see [Update connector names and owners](/baton/manage-connector).
  </Step>
</Steps>
