...
description: "C1 provides identity governance and just-in-time provisioning for Active Directory. Integrate your on-prem Active Directory server with C1 to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1 provides identity governance and just-in-time provisioning for Active Directory. Integrate your on-prem Active Directory server with C1 to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
