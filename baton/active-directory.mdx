...
<Tabs>
  ...
  <Tab title="Self-hosted">
    **Follow these instructions to use the Active Directory connector, hosted and run in your own environment.**
    ...
    For detailed setup instructions including trust requirements, DNS, LDAPS certificates, and Kerberos configuration, see [Multi-domain and cross-forest setup](/baton/active-directory-multi-domain-setup).
