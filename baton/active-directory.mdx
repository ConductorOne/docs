...
- An Active Directory service account
	...
	- For access provisioning, the account needs permissions to modify group membership. See [Entitlement provisioning permissions](#entitlement-provisioning-permissions) below.
