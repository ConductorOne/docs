...
description: "C1.ai provides identity governance for ConfigCat. Integrate your ConfigCat organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for ConfigCat. Integrate your ConfigCat organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "ConfigCat"
---

{/* stargate: cf-configcat-20260605 */}

C1.ai provides identity governance for ConfigCat. Integrate your ConfigCat
organization with C1.ai for unified visibility and governance over user access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your ConfigCat connector is now pulling access data into C1.ai.
  </Tab>
