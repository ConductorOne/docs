...
| Action | Description |
| :--- | :--- |
| `update_giveaccess` | Update the `giveAccess` attribute on a NetSuite employee, controlling whether the employee has login access to NetSuite. Requires the employee's internal ID and a boolean value. |
