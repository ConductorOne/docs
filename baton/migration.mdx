...
We’ve learned a lot since we started building connectors! One key advancement was the creation of the Baton framework for connector development, which C1.ai launched in December 2022.
...
<Steps>
    ...
    <Step>
    Set up the v2 connector in a new C1.ai app.
	When you set up the v2 connector, select the **Create a new app** option.
    </Step>
    <Step>
...
Depending on the complexity of the connected software and how you’ve set it up in C1.ai, this process might be quite simple, or a bit more complex. Our Customer Success team is always ready to talk through the process with you and provide advice and support.
