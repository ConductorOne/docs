...
<Steps>
    ...
    <Step>
    When you’re confident the v2 connector is working as expected, remove the v1 connector and its associated app. Then update any tasks or access profiles that referenced the old app’s users or entitlements to point to the corresponding resources in the new v2 app.
    </Step>
</Steps>
