...
description: "C1 provides identity governance and just-in-time provisioning for ZipHQ. Integrate your ZipHQ instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:title: "Set up ZipHQ connector"
og:description: "C1 provides identity governance and just-in-time provisioning for ZipHQ. Integrate your ZipHQ instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
sidebarTitle: "ZipHQ"
---
