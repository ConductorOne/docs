...
description: "ConductorOne provides identity governance and just-in-time provisioning for ZipHQ. Integrate your ZipHQ instance with ConductorOne to run user access reviews (UARs) and enable just-in-time access requests."
og:title: "Set up ZipHQ connector"
og:description: "ConductorOne provides identity governance and just-in-time provisioning for ZipHQ. Integrate your ZipHQ instance with ConductorOne to run user access reviews (UARs) and enable just-in-time access requests."
sidebarTitle: "ZipHQ"
---
...
<Steps>
    ...
    <Step>
    Check that the connector data uploaded correctly. In ConductorOne, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the ZipHQ connector to. ZipHQ data should be found on the **Entitlements** and **Accounts** tabs.
    </Step>
</Steps>
