---
title: "Set up ZipHQ connector"
description: "C1.ai provides identity governance and just-in-time provisioning for ZipHQ. Integrate your ZipHQ instance with C1.ai to run user access reviews (UARs) and enable just-in-time access requests."
og:title: "Set up ZipHQ connector"
og:description: "C1.ai provides identity governance and just-in-time provisioning for ZipHQ. Integrate your ZipHQ instance with C1.ai to run user access reviews (UARs) and enable just-in-time access requests."
sidebarTitle: "ZipHQ"
---
...
**Done.** Your ZipHQ connector is now pulling access data into C1.ai.
</Tab>
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: baton-ziphq
        image: public.ecr.aws/conductorone/baton-ziphq:latest
...
<Steps>
    ...
    <Step>
    Check that the connector data uploaded correctly. In C1.ai, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the ZipHQ connector to. ZipHQ data should be found on the **Entitlements** and **Accounts** tabs.
    </Step>
</Steps>
