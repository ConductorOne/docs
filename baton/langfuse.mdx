...
description: "C1.ai provides identity governance for Langfuse. Integrate your Langfuse instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Langfuse. Integrate your Langfuse instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Langfuse"
---

C1.ai provides identity governance for Langfuse. Integrate your Langfuse
organization with C1.ai for unified visibility and governance over who can
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Langfuse connector is now pulling access data into C1.ai.
  </Tab>
