...
description: "C1.ai provides identity governance for Gitea. Integrate your Gitea instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Gitea. Integrate your Gitea instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Gitea"
---

C1.ai provides identity governance for Gitea. Integrate your Gitea
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Gitea connector is now pulling access data into C1.ai.
  </Tab>
