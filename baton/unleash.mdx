...
description: "C1.ai provides identity governance for Unleash. Integrate your Unleash instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Unleash. Integrate your Unleash instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Unleash"
---

C1.ai provides identity governance for Unleash. Integrate your Unleash
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Unleash connector is now pulling access data into C1.ai.
  </Tab>
