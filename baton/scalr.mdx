...
description: "C1.ai provides identity governance for Scalr. Integrate your Scalr account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Scalr. Integrate your Scalr account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Scalr"
---

{/* stargate: cf-scalr-20260605 */}

C1.ai provides identity governance for Scalr. Integrate your Scalr account with C1.ai
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Scalr connector is now pulling access data into C1.ai.
  </Tab>
