...
description: "ConductorOne provides identity governance for Wiz. Integrate your Wiz instance with ConductorOne to run user access reviews (UARs) and gain visibility into cloud security access."
og:description: "ConductorOne provides identity governance for Wiz. Integrate your Wiz instance with ConductorOne to run user access reviews (UARs) and gain visibility into cloud security access."
sidebarTitle: "Wiz"
---
