...
description: "C1.ai provides identity governance for Basecamp. Integrate your Basecamp instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Basecamp. Integrate your Basecamp instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Basecamp"
---

C1.ai provides identity governance for Basecamp. Integrate your Basecamp
account with C1.ai for unified visibility and governance over who can access
your projects.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Basecamp connector is now pulling access data into C1.ai.
  </Tab>
