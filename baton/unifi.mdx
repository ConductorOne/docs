...
description: "C1.ai provides identity governance for UniFi Access. Integrate your UniFi Access console with C1.ai for unified visibility and governance over door-access credentials."
og:description: "C1.ai provides identity governance for UniFi Access. Integrate your UniFi Access console with C1.ai for unified visibility and governance over door-access credentials."
sidebarTitle: "UniFi Access"
---

C1.ai provides identity governance for UniFi Access. Integrate your UniFi Access
console with C1.ai for unified visibility and governance over users, visitors, and
...
**Done.** Your UniFi Access connector is now pulling access data into C1.ai.
