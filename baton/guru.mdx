...
description: "C1.ai provides identity governance for Guru. Integrate your Guru team with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Guru. Integrate your Guru team with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Guru"
---

C1.ai provides identity governance for Guru. Integrate your Guru team with C1.ai for
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Guru connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and Guru credentials as environment variables:
