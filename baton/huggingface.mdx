...
description: "C1.ai provides identity governance for Hugging Face. Integrate your Hugging Face organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Hugging Face. Integrate your Hugging Face organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Hugging Face"
---

C1.ai provides identity governance for Hugging Face. Integrate your Hugging Face
organization with C1.ai for unified visibility and governance over who can access
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Hugging Face connector is now pulling access data into C1.ai.
  </Tab>
