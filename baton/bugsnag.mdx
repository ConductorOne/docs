...
description: "C1.ai provides identity governance for Bugsnag. Integrate your Bugsnag instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Bugsnag. Integrate your Bugsnag instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Bugsnag"
---

C1.ai provides identity governance for Bugsnag. Integrate your Bugsnag
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Bugsnag connector is now pulling access data into C1.ai.
  </Tab>
