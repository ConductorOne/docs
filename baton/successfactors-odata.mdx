...
description: "ConductorOne provides identity governance for SAP SuccessFactors. Integrate your SAP SuccessFactors instance with ConductorOne to run user access reviews (UARs) and gain visibility into your workforce identities."
og:description: "ConductorOne provides identity governance for SAP SuccessFactors. Integrate your SAP SuccessFactors instance with ConductorOne to run user access reviews (UARs) and gain visibility into your workforce identities."
...
<Steps>
  ...
  <Step>
    ...
    - **Description**: `ConductorOne identity sync`
    - **Application URL**: your ConductorOne tenant URL
  </Step>
...
openssl req -x509 -newkey rsa:2048 -keyout private-key.pem -out certificate.pem \
  -days 365 -nodes -subj "/CN=ConductorOne"
```
...
{/* AUTO-GENERATED:START - config-params
     Generated from config_schema.json. Do not edit manually. */}
      ...
      <Step>
        ...
        - **LMS Instance URL**: Your SAP SuccessFactors API base URL, e.g. `https://api10.sapsf.com`
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **That's it!** Your SAP SuccessFactors connector is now pulling user data into ConductorOne.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In ConductorOne, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the SAP SuccessFactors connector to. User data should be visible on the **Accounts** tab.
      </Step>
    </Steps>
