...
<Step>
Check that the connector data uploaded correctly. In ConductorOne, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the looker connector to. looker data should be found on the **Entitlements** and **Accounts** tabs.
</Step>
</Steps>
