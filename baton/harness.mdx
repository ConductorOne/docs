...
description: "C1.ai provides identity governance for Harness. Integrate your Harness instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Harness. Integrate your Harness instance with C1.ai for unified visibility and governance over user access."
...
the RBAC surface. A personal API key token also works, but C1.ai recommends a
dedicated service account for connector sync.
</Warning>

<Steps>
  <Step>
    In Harness, create or select the service account that C1.ai will use.
  </Step>
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Harness connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and Harness settings as environment variables:
