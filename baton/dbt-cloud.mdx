...
description: "C1.ai provides identity governance for dbt Cloud. Integrate your dbt Cloud account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for dbt Cloud. Integrate your dbt Cloud account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "dbt Cloud"
---

{/* stargate: cf-dbt-cloud-20260605 */}

C1.ai provides identity governance for dbt Cloud. Integrate your dbt Cloud account
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your dbt Cloud connector is now pulling access data into C1.ai.
  </Tab>
