...
description: "C1.ai provides identity governance and just-in-time provisioning for Arctic Wolf. Integrate your Arctic Wolf instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1.ai provides identity governance and just-in-time provisioning for Arctic Wolf. Integrate your Arctic Wolf instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
...
<Steps>
  <Step>
    In the Aurora console, go to **Settings** > **Integrations** and add a new application (integration) for C1.ai.
  </Step>
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **Done.** Your Arctic Wolf connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    * [GitHub repository](https://github.com/conductorone/baton-arctic-wolf): Access the source code, report issues, or contribute to the project.
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1.ai, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the Arctic Wolf connector to. Arctic Wolf data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>
