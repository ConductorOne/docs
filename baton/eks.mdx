...
description: "C1 provides identity governance for EKS. Integrate your EKS instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:title: "Set up an Amazon Elastic Kubernetes Service connector"
og:description: "C1 provides identity governance for EKS. Integrate your EKS instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
...
**That's it!** Your EKS connector is now pulling access data into C1.
</Tab>
