...
description: "C1 provides identity governance for Elastic Kubernetes Service (EKS). Integrate your EKS instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:title: "Set up an Amazon Elastic Kubernetes Service connector"
og:description: "C1 provides identity governance for Elastic Kubernetes Service (EKS). Integrate your EKS instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
