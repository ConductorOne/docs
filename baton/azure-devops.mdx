...
<Steps>
  ...
  Select your method of authenticating to Azure DevOps.
    ...
    6. **Optional.** Check **Use project RBAC roles** to enable the Cloud Infrastructure Access model for project access. See [Project RBAC](#project-rbac) for details.
    7. Click **Save**.
...
stringData:
  ...
  # Optional: enable the Cloud Infrastructure Access model for project access (see Project RBAC above).
