...
description: "Integrate your Zuora instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:title: "Set up a Zuora connector"
og:description: "Integrate your Zuora instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
sidebarTitle: "Zuora"
---
...
**That's it!** Your Zuora connector is now pulling access data into C1.
