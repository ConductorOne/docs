...
description: "C1.ai provides identity governance and just-in-time provisioning for Zuora. Integrate your Zuora instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1.ai provides identity governance and just-in-time provisioning for Zuora. Integrate your Zuora instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
sidebarTitle: "Zuora"
---
...
| `update_user`   | `user_id` (string, required); `user_profile` (JSON string, required)                                                                                    | Updates profile attributes from a JSON object (used by C1.ai push rules / automated profile sync)       |
...
<Steps>
  ...
  <Step>
    ...
    <Warning>
    The **admin** scope is used by C1.ai when automatically provisioning and deprovisioning access. **If you do not want C1.ai to perform these tasks, do not grant this scope.**
    </Warning>
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Zuora connector is now pulling access data into C1.ai.
  ...
  <Tab title="Self-hosted">
    ...
    * [GitHub repository](https://github.com/conductorone/baton-zuora): Access the source code, report issues, or contribute to the project.
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1.ai, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the Zuora connector to. Zuora data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>
