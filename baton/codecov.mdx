...
description: "C1.ai provides identity governance for Codecov. Integrate your Codecov organization with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Codecov. Integrate your Codecov organization with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Codecov"
---

C1.ai provides identity governance for Codecov. Integrate your Codecov
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Codecov connector is now pulling access data into C1.ai.
  </Tab>
