...
description: "C1.ai provides identity governance and just-in-time provisioning for Valimail. Integrate your Valimail instance with C1.ai to run user access reviews (UARs) and enable just-in-time access requests."
og:title: "Set up a Valimail connector"
og:description: "C1.ai provides identity governance and just-in-time provisioning for Valimail. Integrate your Valimail instance with C1.ai to run user access reviews (UARs) and enable just-in-time access requests."
...
**Done.** Your Valimail connector is now pulling access data into C1.ai.
</Tab>
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: baton-valimail
        image: public.ecr.aws/conductorone/baton-valimail:latest
...
<Steps>
    ...
    <Step>
    Check that the connector data uploaded correctly. In C1.ai, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the Valimail connector to. Valimail data should be found on the **Entitlements** and **Accounts** tabs.
    </Step>
</Steps>
