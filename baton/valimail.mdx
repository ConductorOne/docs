...
description: "C1 provides identity governance and just-in-time provisioning for Valimail. Integrate your Valimail instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:title: "Set up a Valimail connector"
og:description: "C1 provides identity governance and just-in-time provisioning for Valimail. Integrate your Valimail instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
...
**That's it!** Your Valimail connector is now pulling access data into C1.
</Tab>
