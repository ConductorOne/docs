...
description: "C1.ai provides identity governance for Octopus Deploy. Integrate your Octopus instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Octopus Deploy. Integrate your Octopus instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Octopus"
---

C1.ai provides identity governance for Octopus Deploy. Integrate your Octopus
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Octopus connector is now pulling access data into C1.ai.
  </Tab>
