...
description: "C1.ai provides identity governance for Frontegg. Integrate your Frontegg environment with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Frontegg. Integrate your Frontegg environment with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Frontegg"
---

C1.ai provides identity governance for Frontegg. Integrate your Frontegg
environment with C1.ai for unified visibility and governance over tenants, users,
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Frontegg connector is now pulling access data into C1.ai.
  </Tab>
