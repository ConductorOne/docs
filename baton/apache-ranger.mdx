...
description: "C1.ai provides identity governance for Apache Ranger. Integrate your Apache Ranger instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Apache Ranger. Integrate your Apache Ranger instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Apache Ranger"
---

C1.ai provides identity governance for Apache Ranger. Integrate your Apache Ranger
instance with C1.ai for unified visibility and governance over identities, policies,
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Apache Ranger connector is now pulling access data into C1.ai.
  </Tab>
