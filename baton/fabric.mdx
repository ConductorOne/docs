...
description: "C1.ai provides identity governance for Microsoft Fabric. Integrate your Fabric tenant with C1.ai for unified visibility and governance over workspace access."
og:description: "C1.ai provides identity governance for Microsoft Fabric. Integrate your Fabric tenant with C1.ai for unified visibility and governance over workspace access."
sidebarTitle: "Microsoft Fabric"
---

C1.ai provides identity governance for Microsoft Fabric. Integrate your Fabric
tenant with C1.ai for unified visibility and governance over who has access to each
workspace.
...
<Steps>
  ...
  <Step>
    ...
    Viewer access on the workspaces you want C1.ai to see.
  </Step>
</Steps>
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Microsoft Fabric connector is now pulling access data into C1.ai.
  </Tab>
