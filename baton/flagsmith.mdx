...
description: "C1.ai provides identity governance for Flagsmith. Integrate your Flagsmith organisation with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Flagsmith. Integrate your Flagsmith organisation with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Flagsmith"
---

C1.ai provides identity governance for Flagsmith. Integrate your Flagsmith
organisation with C1.ai for unified visibility and governance over user access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Flagsmith connector is now pulling access data into C1.ai.
  </Tab>
