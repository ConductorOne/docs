...
description: "C1.ai provides identity governance for Gong. Integrate your Gong instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Gong. Integrate your Gong instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Gong"
---
...
**Done.** Your Gong connector is now pulling access data into C1.ai.
</Tab>
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: baton-gong
        image: public.ecr.aws/conductorone/baton-gong:latest
...
<Step>
Check that the connector data uploaded correctly. In C1.ai, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the gong connector to. gong data should be found on the **Entitlements** and **Accounts** tabs.
</Step>
</Steps>
