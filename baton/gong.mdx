...
description: "C1 provides identity governance and just-in-time provisioning for Gong. Integrate your Gong instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:description: "C1 provides identity governance and just-in-time provisioning for Gong. Integrate your Gong instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
sidebarTitle: "Gong"
---
