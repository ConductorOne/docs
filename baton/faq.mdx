...
Add these egress IPs to your allowlist to permit outbound connector traffic from ConductorOne to reach your systems.
...
Add these egress IPs to your allowlist to allow outbound connector traffic from ConductorOne.
