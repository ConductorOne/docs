...
description: "C1.ai provides identity governance for Sage Intacct. Integrate your Sage Intacct instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1.ai provides identity governance for Sage Intacct. Integrate your Sage Intacct instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
