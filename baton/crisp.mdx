...
description: "C1.ai provides identity governance for Crisp. Integrate your Crisp instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Crisp. Integrate your Crisp instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Crisp"
---

C1.ai provides identity governance for Crisp. Integrate your Crisp website with
C1.ai for unified visibility and governance over the operators who can access your
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Crisp connector is now pulling access data into C1.ai.
  </Tab>
