...
description: "C1.ai provides identity governance for Gladly. Integrate your Gladly instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Gladly. Integrate your Gladly instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Gladly"
---

C1.ai provides identity governance for Gladly. Integrate your Gladly
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Gladly connector is now pulling access data into C1.ai.
  </Tab>
