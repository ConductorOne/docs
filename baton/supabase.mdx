...
description: "C1.ai provides identity governance and provisioning for Supabase. Integrate Supabase with C1.ai to run user access reviews (UARs), enable access requests, and automatically provision and deprovision auth users across all your Supabase projects."
og:description: "C1.ai provides identity governance and provisioning for Supabase. Integrate Supabase with C1.ai to run user access reviews (UARs), enable access requests, and automatically provision and deprovision auth users across all your Supabase projects."
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **Done.** Your Supabase connector is now pulling access data into C1.ai.
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1.ai, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the Supabase connector to. Supabase data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>
