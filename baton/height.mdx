...
description: "C1.ai provides identity governance for Height. Integrate your Height workspace with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Height. Integrate your Height workspace with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Height"
---

C1.ai provides identity governance for Height. Integrate your Height workspace
with C1.ai for unified visibility and governance over who belongs to your
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Height connector is now pulling access data into C1.ai.
  </Tab>
