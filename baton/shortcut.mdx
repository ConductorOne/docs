...
description: "C1.ai provides identity governance for Shortcut. Integrate your Shortcut instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Shortcut. Integrate your Shortcut instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Shortcut"
---

C1.ai provides identity governance for Shortcut. Integrate your Shortcut
workspace with C1.ai for unified visibility and governance over members and
group membership.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Shortcut connector is now pulling access data into C1.ai.
  </Tab>
