...
description: "C1.ai provides identity governance for Logto. Integrate your Logto tenant with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Logto. Integrate your Logto tenant with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Logto"
---

C1.ai provides identity governance for Logto. Integrate your Logto tenant with C1.ai
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Logto connector is now pulling access data into C1.ai.
  </Tab>
