...
### Step 3: Force domain controller certificate auto-enrollment
...
- **Cross-forest LDAPS**: Each forest's CA certificate must be independently trusted. See [Multi-domain and cross-forest setup](/baton/active-directory/multi-domain-setup) for details
