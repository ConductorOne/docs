...
<Step>
Check that the connector data uploaded correctly. In ConductorOne, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the launchdarkly connector to. launchdarkly data should be found on the **Entitlements** and **Accounts** tabs.
</Step>
</Steps>
