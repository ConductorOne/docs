...
description: "C1.ai provides identity governance for LaunchDarkly. Integrate your LaunchDarkly instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for LaunchDarkly. Integrate your LaunchDarkly instance with C1.ai for unified visibility and governance over user access."
...
**Done.** Your LaunchDarkly connector is now pulling access data into C1.ai.
</Tab>
...
<Step>
Check that the connector data uploaded correctly. In C1.ai, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the launchdarkly connector to. launchdarkly data should be found on the **Entitlements** and **Accounts** tabs.
</Step>
</Steps>
