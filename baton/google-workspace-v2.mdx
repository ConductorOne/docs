...
<Step>
For using Group settings actions, you will need to also enable the  **Groups Settings API**. <br />Repeat the process from step 2 searching for **Groups Settings API**
