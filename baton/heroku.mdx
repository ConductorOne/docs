...
description: "C1.ai provides identity governance for Heroku. Integrate your Heroku platform with C1.ai for unified visibility and governance over user, team, app collaborator, and enterprise account access."
og:description: "C1.ai provides identity governance for Heroku. Integrate your Heroku platform with C1.ai for unified visibility and governance over user, team, app collaborator, and enterprise account access."
sidebarTitle: "Heroku"
---

C1.ai provides identity governance for Heroku. Integrate your Heroku instance
with C1.ai for unified visibility and governance over user, team, app
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Heroku connector is now pulling access data into C1.ai.
  </Tab>
