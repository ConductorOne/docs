...
description: "C1.ai provides identity governance for Kayako. Integrate your Kayako instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Kayako. Integrate your Kayako instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Kayako"
---

C1.ai provides identity governance for Kayako. Integrate your Kayako instance with
C1.ai for unified visibility and governance over the people who can access your
Kayako help desk.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Kayako connector is now pulling access data into C1.ai.
  </Tab>
