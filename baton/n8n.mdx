...
description: "C1.ai provides identity governance and just-in-time provisioning for n8n. Integrate your n8n instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision global roles and project membership."
og:description: "C1.ai provides identity governance and just-in-time provisioning for n8n. Integrate your n8n instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision global roles and project membership."
sidebarTitle: "n8n"
---
...
- n8n does not support disabling or suspending users — only inviting or deleting them. C1.ai cannot suspend n8n users.
- Project membership provisioning is blocked by n8n (returns 403) when SSO-based provisioning is enabled on the instance. C1.ai will report the error if this occurs.
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **Done.** Your n8n connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1.ai, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the n8n connector to. n8n data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>
