...
description: "ConductorOne provides identity governance and just-in-time provisioning for n8n. Integrate your n8n instance with ConductorOne to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision global roles and project membership."
og:description: "ConductorOne provides identity governance and just-in-time provisioning for n8n. Integrate your n8n instance with ConductorOne to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision global roles and project membership."
sidebarTitle: "n8n"
---
...
| Global Roles | <Icon icon="square-check" iconType="solid" color="#65DE23"/> | <Icon icon="square-check" iconType="solid" color="#65DE23"/> |
...
- n8n does not support disabling or suspending users — only inviting or deleting them. ConductorOne cannot suspend n8n users.
- Project membership provisioning is blocked by n8n (returns 403) when SSO-based provisioning is enabled on the instance. ConductorOne will report the error if this occurs.
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **That's it!** Your n8n connector is now pulling access data into ConductorOne.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In ConductorOne, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the n8n connector to. n8n data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>
