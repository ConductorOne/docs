...
description: "C1.ai provides identity governance for PagerTree. Integrate your PagerTree account with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for PagerTree. Integrate your PagerTree account with C1.ai for unified visibility and governance over user access."
sidebarTitle: "PagerTree"
---

{/* stargate */}

C1.ai provides identity governance for PagerTree. Integrate your PagerTree account
with C1.ai for unified visibility and governance over the users who can access
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your PagerTree connector is now pulling access data into C1.ai.
  </Tab>
