...
description: "C1.ai provides identity governance for Workable. Integrate your Workable account with C1.ai for unified visibility and governance over member access."
og:description: "C1.ai provides identity governance for Workable. Integrate your Workable account with C1.ai for unified visibility and governance over member access."
sidebarTitle: "Workable"
---

C1.ai provides identity governance for Workable. Integrate your Workable account
with C1.ai for unified visibility and governance over the members who can access
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Workable connector is now pulling access data into C1.ai.
  </Tab>
