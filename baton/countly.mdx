...
description: "C1.ai provides identity governance for Countly. Integrate your Countly instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Countly. Integrate your Countly instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Countly"
---

C1.ai provides identity governance for Countly. Integrate your Countly
instance with C1.ai for unified visibility and governance over the dashboard
users in your apps.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Countly connector is now pulling access data into C1.ai.
  </Tab>
