...
description: "C1.ai provides identity governance for Breathe. Integrate your Breathe instance with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Breathe. Integrate your Breathe instance with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Breathe"
---

C1.ai provides identity governance for Breathe. Integrate your Breathe instance
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Breathe connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Configure C1.ai credentials and Breathe credentials as environment
        variables:
