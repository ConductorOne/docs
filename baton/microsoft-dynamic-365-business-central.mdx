...
description: "C1.ai provides identity governance for Microsoft Dynamics 365 Business Central. Integrate your Business Central environment with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Microsoft Dynamics 365 Business Central. Integrate your Business Central environment with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Microsoft Dynamics 365 Business Central"
---

C1.ai provides identity governance for Microsoft Dynamics 365 Business Central. Integrate your Business
Central environment with C1.ai for unified visibility and governance over who can access Business Central
...
<Steps>
  ...
  <Step>
    ...
    **Automation.ReadWrite.All**,
    then grant admin consent for your tenant. If you add this permission after already granting
    consent once, you need to grant admin consent again — consent doesn't retroactively cover
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Microsoft Dynamics 365 Business Central connector is now pulling access data into C1.ai.
  </Tab>
