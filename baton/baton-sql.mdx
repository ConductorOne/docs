...
- SQLite
- Amazon Redshift
- IBM DB2 (available on request — [contact C1's support team](mailto:support@conductorone.com) for a binary)
...
<Note>
IBM DB2 requires a separate binary bundled with IBM's client driver and isn't available from the standard download center. [Contact C1's support team](mailto:support@conductorone.com) to request a DB2-enabled binary. Customers connecting to DB2 are responsible for providing their own IBM Db2 Connect license where required.
</Note>
