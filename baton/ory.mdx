...
description: "C1.ai provides identity governance for Ory. Integrate your Ory project with C1.ai for unified visibility over user identities."
og:description: "C1.ai provides identity governance for Ory. Integrate your Ory project with C1.ai for unified visibility over user identities."
sidebarTitle: "Ory"
---

C1.ai provides identity governance for Ory. Integrate your Ory project with C1.ai
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Ory connector is now pulling identity data into C1.ai.
  </Tab>
