...
description: "C1 provides identity governance and just-in-time provisioning for NinjaOne. Integrate your NinjaOne instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
og:description: "C1 provides identity governance and just-in-time provisioning for NinjaOne. Integrate your NinjaOne instance with C1 to run user access reviews (UARs) and enable just-in-time access requests."
...
**That's it!** Your NinjaOne connector is now pulling access data into C1.
</Tab>
