...
description: "C1.ai provides identity governance for Doppler. Integrate your Doppler workplace with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Doppler. Integrate your Doppler workplace with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Doppler"
---

C1.ai provides identity governance for Doppler. Integrate your Doppler
workplace with C1.ai for unified visibility and governance over user access.
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Doppler connector is now pulling access data into C1.ai.
  </Tab>
