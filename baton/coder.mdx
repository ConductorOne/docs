...
description: "C1.ai provides identity governance for Coder. Integrate your Coder deployment with C1.ai for unified visibility and governance over user access."
og:description: "C1.ai provides identity governance for Coder. Integrate your Coder deployment with C1.ai for unified visibility and governance over user access."
sidebarTitle: "Coder"
---

C1.ai provides identity governance for Coder. Integrate your Coder deployment with
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Coder connector is now pulling access data into C1.ai.
  </Tab>
