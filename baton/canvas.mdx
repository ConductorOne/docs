...
description: "C1.ai provides identity governance for Canvas LMS. Integrate your Canvas instance with C1.ai for unified visibility and governance over user access to accounts, courses, and enrollments."
og:description: "C1.ai provides identity governance for Canvas LMS. Integrate your Canvas instance with C1.ai for unified visibility and governance over user access to accounts, courses, and enrollments."
sidebarTitle: "Canvas"
---

C1.ai provides identity governance for Canvas LMS by Instructure. Integrate your
Canvas instance with C1.ai for unified visibility and governance over who has
...
entitlements, and C1.ai records a grant for every user enrolled in that course
...
<Tabs>
  <Tab title="Cloud-hosted">
    ...
    **Done.** Your Canvas connector is now pulling access data into C1.ai.
  </Tab>
...
<CardGroup cols="2">
  <Card title="ConductorOne connectors" iconType="duotone" icon="plug" href="https://www.conductorone.com/docs/product/integrations/">
    Browse the full catalog of ConductorOne connectors and integrations.
  </Card>
  <Card title="ConductorOne documentation" iconType="duotone" icon="book" href="https://www.conductorone.com/docs/">
    Learn more about identity governance and access management with C1.ai.
  </Card>
</CardGroup>
