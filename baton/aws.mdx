...
<Steps>
	...
	**Section 4: Other permissions**
	...
	- `IAMListPermissions`: This section allows C1 to sync data on access keys. ConductorOne does not store or access the access keys. If you do not want to sync access key data, you can omit this section.
