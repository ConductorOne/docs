---
title: "Set up Monday.com connector"
og:title: "Set up Monday.com connector"
description: "C1.ai provides identity governance and just-in-time provisioning for Monday.com. Integrate your Monday.com instance with C1.ai to run user access reviews (UARs) and enable just-in-time access requests."
og:description: "C1.ai provides identity governance and just-in-time provisioning for Monday.com. Integrate your Monday.com instance with C1.ai to run user access reviews (UARs) and enable just-in-time access requests."
...
Monday.com users keep the same ID from invitation through deactivation. The connector maps each lifecycle state to a C1.ai account status and blocks unsupported operations with clear errors.

**How users appear in C1.ai after sync:**

| User state | C1.ai account status | Included in sync |
| :--- | :--- | :--- |
...
**Done.** Your Monday.com connector is now pulling access data into C1.ai.
</Tab>
...
<Step>
Check that the connector data uploaded correctly. In C1.ai, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the Monday.com connector to. Monday.com data should be found on the **Entitlements** and **Accounts** tabs.
</Step>
</Steps>
