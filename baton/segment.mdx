...
description: "C1 provides identity governance and just-in-time provisioning for Twilio Segment. Integrate your Twilio Segment workspace with ConductorOne to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1 provides identity governance and just-in-time provisioning for Twilio Segment. Integrate your Twilio Segment workspace with ConductorOne to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
