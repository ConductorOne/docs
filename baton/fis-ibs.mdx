...
description: "C1.ai provides identity governance and just-in-time provisioning for FIS IBS. Integrate your FIS IBS instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
og:description: "C1.ai provides identity governance and just-in-time provisioning for FIS IBS. Integrate your FIS IBS instance with C1.ai to run user access reviews (UARs), enable just-in-time access requests, and automatically provision and deprovision access."
...
{/* AUTO-GENERATED:END - config-params */}
    ...
    **Done.** Your FIS IBS connector is now pulling access data into C1.ai.
  </Tab>
  ...
  <Tab title="Self-hosted">
    ...
    <Steps>
      ...
      <Step>
        Check that the connector data uploaded correctly. In C1.ai, click **Applications**. On the **Managed apps** tab, locate and click the name of the application you added the FIS IBS connector to. FIS IBS data should be found on the **Entitlements** and **Accounts** tabs.
      </Step>
    </Steps>
