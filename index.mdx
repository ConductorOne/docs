...
<div className="min-h-screen">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
      {/* Feature Card 1 */}
      <div className="group rounded-xl p-8 border border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all duration-300" onMouseEnter={(e) => e.currentTarget.style.borderColor = ‘#1e5f67’} onMouseLeave={(e) => e.currentTarget.style.borderColor = ‘’}>
        <div className="w-12 h-12 bg-[#e0f4f4] dark:bg-[#0d3338] rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
          <svg className="w-6 h-6" style={{ color: ‘#1e5f67’ }} viewBox="0 0 40 40" fill="none">
