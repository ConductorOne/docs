    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="group rounded-xl p-8 border border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all duration-300" style={{ '--hover-border': '#5b39f5' }} onMouseEnter={(e) => e.currentTarget.style.borderColor = '#5b39f5'} onMouseLeave={(e) => e.currentTarget.style.borderColor = ''}>
        ...
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          Automate security for all your human, non-human, and AI identities. Run access reviews, enable self-service access, and set up just-in-time access for AWS and other key resources.
        </p>
        <a href="/product/intro" className="inline-flex items-center mt-4 font-medium hover:underline" style={{ color: '#5b39f5' }}>
          Learn more
      ...
      <div className="group rounded-xl p-8 border border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all duration-300" onMouseEnter={(e) => e.currentTarget.style.borderColor = '#66dd23'} onMouseLeave={(e) => e.currentTarget.style.borderColor = ''}>
        ...
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          Pre-built connectors for Okta, Google Workspace, AWS, GitHub, and more. Build custom connectors with our open-source Baton SDK to integrate any app, even niche or legacy systems.
        </p>
        <a href="/baton/intro" className="inline-flex items-center mt-4 font-medium hover:underline" style={{ color: '#66dd23' }}>
          Learn more
          <svg className="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          </svg>
      ...
      <div className="group rounded-xl p-8 border border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all duration-300" onMouseEnter={(e) => e.currentTarget.style.borderColor = '#325bad'} onMouseLeave={(e) => e.currentTarget.style.borderColor = ''}>
        ...
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          Work with our API, Go and TypeScript SDKs, Terraform provider, and Postman integration. Integrate with, manage, and extend the ConductorOne platform programmatically.
        </p>
        <a href="/developer/intro" className="inline-flex items-center mt-4 font-medium hover:underline" style={{ color: '#325bad' }}>
          Learn more
          <svg className="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          </svg>
