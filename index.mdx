  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 relative">
    <div className="text-center">
      ...
      <p className="mt-6 text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed">
        Everything you need to configure, extend, and get the most out of C1.ai.
      </p>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
      ...
      <div className="group rounded-xl p-8 border border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all duration-300" style={{ '--hover-border': '#1e5f67' }} onMouseEnter={(e) => e.currentTarget.style.borderColor = '#1e5f67'} onMouseLeave={(e) => e.currentTarget.style.borderColor = ''}>
        ...
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          Request access, complete review tasks, and use AI tools and MCP clients as an end user of C1.ai.
        </p>
      ...
      <div className="group rounded-xl p-8 border border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all duration-300" style={{ '--hover-border': '#1e5f67' }} onMouseEnter={(e) => e.currentTarget.style.borderColor = '#1e5f67'} onMouseLeave={(e) => e.currentTarget.style.borderColor = ''}>
        ...
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          Work with our Go and TypeScript SDKs, Terraform provider, and Postman integration. Integrate with, manage, and extend the C1.ai platform programmatically.
        </p>
      ...
      <div className="group rounded-xl p-8 border border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all duration-300" style={{ '--hover-border': '#1e5f67' }} onMouseEnter={(e) => e.currentTarget.style.borderColor = '#1e5f67'} onMouseLeave={(e) => e.currentTarget.style.borderColor = ''}>
        ...
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          Extend C1.ai's power into your own ecosystem. Automate access requests, export audit data for compliance reporting, and integrate identity security directly into your internal tools and developer workflows.
        </p>
