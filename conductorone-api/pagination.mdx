---
title: Pagination in the C1.ai API
description: "When making `LIST` or `SEARCH` requests to the C1.ai API, use the `page_size` and `page_token` parameters to navigate through the list of results."
---
