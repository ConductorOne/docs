...
og:title: Use c1i with AI coding agents | Docs - C1.ai
og:description: Set up c1i as a skill for Claude Code, Cursor, and other AI coding agents so they can manage users, apps, entitlements, and access requests in C1.ai.
description: Set up c1i as a skill for Claude Code, Cursor, and other AI coding agents so they can manage users, apps, entitlements, and access requests in C1.ai.
...
When you add this skill file to your agent's context, the agent can manage users, apps, entitlements, tasks, and access requests in C1.ai through natural-language instructions.
...
The agent runs `c1i accounts list --app-id=<id> --unmapped-only` to surface accounts that haven't been linked to C1.ai users.
...
```shell
# Update c1i
brew upgrade conductorone/baton/c1i
