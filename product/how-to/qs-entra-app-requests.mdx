...
Start by integrating your Microsoft Entra instance with ConductorOne. Use the [Microsoft Entra connector](/baton/entra) to sync Microsoft Entra to ConductorOne.
