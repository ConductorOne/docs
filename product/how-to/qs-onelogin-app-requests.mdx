...
og:title: How to set up access requests with OneLogin apps - ConductorOne docs
...
Start by integrating your OneLogin instance with ConductorOne. Use the [OneLogin connector](/baton/onelogin-v2) to sync OneLogin to ConductorOne.
...
If groups are assigned to the application in OneLogin, you can convert these linked entitlements from OneLogin into in-app entitlements in the ConductorOne app:
