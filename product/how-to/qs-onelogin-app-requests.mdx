...
og:title: How to set up access requests with OneLogin apps - C1 docs
...
Before managing access to a OneLogin app, you'll need to begin managing it with C1.
...
C1 will now create the resources and entitlements in the managed app and set a binding for that entitlement to the OneLogin group. This binding is what allows C1 to automatically provision access when a user is granted the entitlement.
...
The request will be auto-approved based on the policy, and C1 will provision your access by assigning you to the application and the correct groups in OneLogin.
