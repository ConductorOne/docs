...
og:title: How to set up access requests with Okta apps - ConductorOne docs
...
Start by integrating your Okta instance with ConductorOne. Use the [Okta connector](/baton/okta-v2) to sync Okta to ConductorOne.
...
If groups are assigned to the application in Okta, you can convert these linked entitlements from Okta into in-app entitlements in the ConductorOne app:
