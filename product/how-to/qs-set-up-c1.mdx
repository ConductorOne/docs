...
<Callout icon="globe" color="#c937ae" iconType="regular">If your tenant is on the EU data residency instance, substitute `c1eu.ai` for `conductor.one` when forming URLs.</Callout>
...
<Callout icon="globe" color="#FF92EB" iconType="regular">If your tenant is on the EU data residency instance, substitute `c1eu.ai` for `conductor.one` when forming URLs.</Callout>
