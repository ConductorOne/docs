...
og:title: How to set up C1 - C1 docs
og:description: Follow our step-by-step guide to setting up C1.  
description: Follow this step-by-step guide to creating a new C1 tenant.
---
