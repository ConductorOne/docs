...
C1 runs two hosting options: a **default instance** and an **EU data residency instance**. Your tenant is provisioned in one region, and every tenant-specific URL — login, redirect URIs, API and webhook endpoints, MCP server, and CLI configuration — reflects that region.
