...
Start by integrating your GCP instance with ConductorOne by following the instructions in [Google Workspace & Google Cloud Platform](/baton/google-cloud-platform).
