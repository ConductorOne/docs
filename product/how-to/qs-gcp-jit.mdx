...
og:title: "How to set up GCP just-in-time (JIT) access - C1 docs"
...
Once connected, ConductorOne ingests all of the projects, resources, and entitlements for Google Cloud. This includes projects and roles. You can see all the resources and entitlements by navigating to **Apps** > **Google Cloud Platform** and clicking the **Entitlements** tab.

## Step 2: Configure GCP projects for JIT access

Now that GCP is hooked up to C1, set GCP projects and roles as available for just-in-time access. To do this, we'll configure access controls for each of the GCP projects. 
