...
Once connected, C1 ingests all of the projects, resources, and entitlements for Google Cloud. This includes projects and roles. You can see all the resources and entitlements by navigating to **Apps** > **Google Cloud Platform** and clicking the **Entitlements** tab.
