...
- **Claude Desktop** — Settings > Connectors > Add connector > paste the MCP URL.
...
Some downstream services (Google Workspace, GitHub, Salesforce, and so on) require your personal credentials, not a shared service account. You need to connect the MCP connection (**AI & API > MCP Connection > Connect**) before you can use the tools from one of these services.
