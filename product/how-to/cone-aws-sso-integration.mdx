...
og:title: How to use Cone with AWS IAM Identity Center - C1 docs
...
If you have an active grant for the permission set in C1, Cone fetches temporary credentials from AWS IAM Identity Center and returns them to the AWS CLI. The command succeeds as if you were using native AWS IAM Identity Center.
