...
3. **AI assistant**: Ask the C1 AI assistant what actions are available to you — on the web or in Slack.
...
You can discover and request actions directly from the C1 AI assistant without navigating to the Actions catalog. This works both in the C1 web app and in Slack.

<Steps>
<Step>
Open the AI assistant. In the C1 web app, navigate to **Assistant**. In Slack, open the C1 app and go to the **Chat** tab, or type `@C1` in any channel where the app is installed.
</Step>
<Step>
