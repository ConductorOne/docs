...
og:title: How to request actions - C1 docs
og:description: Request on-demand actions like device provisioning, resource creation, or operational workflows through C1's Actions catalog.
description: Request on-demand actions like device provisioning, resource creation, or operational workflows through C1's Actions catalog.
---
...
3. **AI assistant**: Ask the C1 AI assistant in the C1 app for Slack what actions are available to you.
...
If your company uses Slack and an admin has set up the C1 app for Slack, you can discover and request actions directly from the C1 AI assistant, without navigating to the Actions catalog.

<Steps>
<Step>
Open the C1 app for Slack and go to the **Chat** tab, or type `@C1` in any channel where the app is installed.
</Step>
<Step>
Ask the assistant what actions are available to you. It will return a list of the actions you have permission to request.

<Frame>
<img src="/images/product/assets/slack-all-actions.png" alt="The C1 assistant responding to 'What actions can I request right now?' with a table listing available actions and their descriptions." />
</Frame>
</Step>
<Step>
...
<Frame>
<img src="/images/product/assets/slack-assistant-action.png" alt="The C1 assistant surfacing the 'Can't find an application?' request form with a Fill out form button." />
</Frame>
</Step>
<Step>
