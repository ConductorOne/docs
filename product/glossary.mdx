...
#### ConductorOne app
A special application that models ConductorOne within ConductorOne. Allows you to review and manage access to C1 using ConductorOne’s tools. Very meta, very useful. 
...
#### Cone
ConductorOne’s command-line interface (CLI) tool. Allows you to interact with C1 from the comfort of your terminal window. Named in reference to C1’s nickname “C1”, with the “one” spelled out. Pronounced like the ice cream holder or traffic diverter of the same name. 
...
#### Copilot
ConductorOne’s AI-powered assistant, which provides insights, help, and guidance throughout C1 to help you make informed choices and get work done efficiently. 
...
An integration with your organization’s IT ticketing system, such as Jira or ServiceNow. Once configured, when manual provisioning of new access is required, ConductorOne automatically creates a ticket in the connected external ticketing system. ConductorOne will monitor the status of the ticket and mark the provisioning step complete in C1 once the ticket is closed. 
...
#### Revoke / Revocation
Broadly, when a permission that was granted to a user is removed, this is a revocation. In ConductorOne, a revocation task is created when the user, their manager, or a reviewer during a UAR campaign recommends that the access be removed. The revocation task is governed by a revoke policy. (“Revoke” and “revocation” are used interchangeably in C1 since unlike “review” and “request”, the noun and verb forms differ.) See [Task](/product/glossary#task) and [Policy](/product/glossary#policy). 
...
#### User
A human at your organization whose access data is synced to C1, and who can be assigned tasks in C1. ConductorOne user accounts are automatically created when you set directories as sources of user data. See [Directory](/product/glossary#directory). 
