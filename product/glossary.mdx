...
#### C1
Shortened form of “C1”, used informally and for faster typing. 
...
#### Cone
C1’s command-line interface (CLI) tool. Allows you to interact with C1 from the comfort of your terminal window. Named in reference to C1’s nickname “C1”, with the “one” spelled out. Pronounced like the ice cream holder or traffic diverter of the same name. 
