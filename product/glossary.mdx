...
#### Connector
Integration code that connects ConductorOne to another software tool or service. Used as the source of data for applications in C1. All connectors can read (sync) data, and some can also write (provision) to the connected software. See [Application](/product/glossary#application). 
