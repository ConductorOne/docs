...
#### Copilot
C1’s AI-powered assistant, which provides insights, help, and guidance throughout C1 to help you make informed choices and get work done efficiently. 
...
A special AI-powered integration that allows C1 to automatically create request tasks based on the information entered in a service desk ticketing system such as Jira. 
