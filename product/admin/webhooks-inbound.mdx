...
og:title: "Inbound webhooks - C1 docs"
og:description: "Configure inbound webhooks to let external systems trigger C1 automations via authenticated HTTP requests."
description: "Configure inbound webhooks to let external systems trigger C1 automations via authenticated HTTP requests."
