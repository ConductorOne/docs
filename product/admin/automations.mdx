...
**That's it!** You can review and update this automation on the **Unused access** section of the app's **Overview** page (users with the **Super Admin** role can also see it on **Automations**). You can also add additional usage-based automations to this app to further fine-tune how unused access is managed.
