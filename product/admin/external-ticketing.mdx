...
You can pull data from ConductorOne into your external ticketing system so that each ticket shows specific details about the access request, user, application, and entitlement. The variables listed below can be used when setting up the ticket template fields in C1 to generate a unique, customized title and description for each external ticket.
