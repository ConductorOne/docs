...
<Steps>
<Step>
Return to the C1 **Platform** > **External data sources** page if necessary and navigate to your newly created external data source.
</Step>
<Step>
...
<Steps>
<Step>
In C1, navigate to **Platform** > **External data sources**. 
</Step>
<Step>
