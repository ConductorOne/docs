...
og:title: Step-up authentication - C1 docs
...
Configure the application:
   ...
   - **Sign-in redirect URIs** (use whichever matches your C1 tenant's domain):
...
<Steps>
<Step>
In C1, navigate to **Settings** > **Step-up authentication**.
</Step>
<Step>
...
Configure the application:
   ...
   - **Redirect URI**: Platform: Web. URI (use whichever matches your C1 tenant's domain):
     - Default instance: `https://accounts.conductor.one/auth/callback`
     - EU data residency instance: `https://accounts.c1eu.ai/auth/callback`
</Step>
<Step>
