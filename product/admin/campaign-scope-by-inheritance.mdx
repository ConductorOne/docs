...
Resource-based selections work for any app in C1. Scope and role pair selections — where you review who holds a role at a specific level of a resource hierarchy — are only available for [cloud infrastructure apps](/product/admin/cloud-infrastructure-access).
