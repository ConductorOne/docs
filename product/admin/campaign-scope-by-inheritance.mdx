...
This scope type is designed for cloud infrastructure apps like Azure, where permissions cascade through a resource hierarchy (for example, management groups → subscriptions → resource groups → resources).
...
<Step>
Fill out the campaign details and click **Continue**.
</Step>
<Step>
On the **Scope** tab, under **Review scope type**, select **By inheritance**.
</Step>
<Step>
Configure your scope selections:

- **Scope and role pairs.** Select a combination of a scope resource (such as a subscription) and a role (such as Owner) to review who holds that role within that part of the resource hierarchy.
- **Resources.** Select the specific resources to review. The resource list shows the hierarchy so you can see parent and child relationships. C1 expands each selection to include access inherited from parent resources.
</Step>
<Step>
...
## Features related to access review campaigns

- [Create an access review campaign](/product/admin/campaigns)
- [Manage active campaigns](/product/admin/manage-campaigns)
