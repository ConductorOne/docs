...
og:description: Configure ConductorOne to send notification emails through your own Google Workspace mailbox so recipients see your company's domain as the sender.
description: Configure ConductorOne to send notification emails through your own Google Workspace mailbox so recipients see your company's domain as the sender.
...
<Step>
**Optional:** In Gmail, go to **Settings** > **Accounts** > **Send mail as**, edit the primary identity, and set **Name** to the display name you want recipients to see (e.g., Governance Team). Gmail may override custom display names from the MIME header with this value.
</Step>
</Steps>
...
<Step>
Set a name (e.g., C1 Email Sender) and click **Create and continue**. No project roles are required — click **Continue**, then **Done**.
</Step>
<Step>
...
- **Sender email address**: The mailbox you created in Step 1 (e.g., `governance@yourcompany.com`).
