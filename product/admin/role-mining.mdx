...
<Steps>
  ...
  <Step>
    Select one or more values for the attribute. Each value shows how many users hold it and what share of your directory that represents. Click **Done** to collapse the value picker — this doesn't change your selections, but the picker can't be reopened afterward. To change the values later, delete the filter and add it again.
