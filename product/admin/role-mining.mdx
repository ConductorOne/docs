...
og:title: "Discover access profiles with role mining - C1.ai docs"
...
Role mining analyzes the access granted to your organization's users and identifies patterns that suggest well-defined access profiles. Instead of building access profiles by hand, you can use role mining to let C1.ai surface which entitlements are commonly held by similar groups of people, then turn those patterns into ready-to-use profiles.
...
- You must have the **Super Admin** role in C1.ai to use role mining.
...
<Steps>
  ...
  <Step>
    Add more filters as needed with **Add filter**. C1.ai updates the results as you build your cohort.
  </Step>
</Steps>
