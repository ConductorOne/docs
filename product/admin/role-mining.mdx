...
Accepting a suggestion creates a new access profile with the recommended entitlements. The profile starts with no enrolled members — you'll need to add members from the profile's **Enrollment** tab. 