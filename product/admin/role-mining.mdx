...
- **Suggestions**: ConductorOne continuously analyzes access patterns across your organization and surfaces recommended access profiles, grouped by cohorts like department, job title, and manager's team.
...
Role mining works in the opposite direction from how you might expect. You start with a **group of people**, and role mining tells you what access they have in common. You don't start with a set of entitlements and discover who should have them.

This means role mining is most useful when you already have a meaningful way to group your users — by department, job title, manager, or another attribute — and you want to answer the question: "What access does this group typically need?"

If you want to build an access profile from scratch by selecting entitlements directly, use **Governance** > **Access profiles** instead. Role mining is the right tool when you want ConductorOne to propose entitlements based on what real users in a cohort already have.
...
<AccordionGroup>
  ...
  <Accordion title="How does ConductorOne decide what to suggest?">
    ConductorOne groups users by shared attributes like department, job title, and manager's team. Within each group, it identifies entitlements that appear frequently across members. The confidence score reflects what percentage of group members hold that entitlement.
  </Accordion>
