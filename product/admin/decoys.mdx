...
You can configure C1 so that use of a decoy triggers a [Critical finding](/product/admin/findings).

Managing decoys requires the **Super Administrator** role in C1. 
...
If a decoy's secret turns up published somewhere public — a paste site, a public repository — C1 can raise a separate **Decoy publicly exposed** finding. The finding includes the scanner that found it, where it was found, and when.
