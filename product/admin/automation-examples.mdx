...
1. Navigate to the Salesforce application page and find the **Unused access** section on the **Overview** page. Click **Add automation** and select **Create a custom usage-based automation from scratch**.
