...
You can also generate a CSV report of all tasks in the campaign by clicking the **Generate CSV** icon at the top of the **Tasks** tab. Your report will be prepared and posted in the downloads center at the top of the page when ready.
