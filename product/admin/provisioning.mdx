...
ConductorOne allows you to manage provisioning in the downstream app by creating the linkage between that managed app in C1 and the SSO directory or identity provider.
