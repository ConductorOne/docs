...
By default, functions have no access to the C1 APIs. To grant access, assign one or more roles in the **Scopes** section of the config drawer. The function's SDK credentials are created with only the permissions those roles allow.
