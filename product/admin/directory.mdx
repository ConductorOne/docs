...
<Step>
Click the **...** (more actions) menu next to the directory and select **Edit**.
</Step>
<Step>
...
To write a custom [CEL expression](/product/admin/expressions) instead of using a preset field, click **CEL**.
</Step>
<Step>
