...
<Note>
Only users with **Super Admin** or **Read-Only Admin** roles can authorize AI connections during this phase of the early access program.
</Note>
...
Super Admins can navigate to **Settings** > **Developers** > **AI connections** to view and revoke all connections across the tenant.
