...
Go to **Settings** in the left navigation, open the **AI** section, and select **Cross-App Access**. The page is read-only until you click **Edit** (top right). Make your changes, then click **Save**.
