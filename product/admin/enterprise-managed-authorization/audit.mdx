...
This is the path we recommend for every customer auditing MCP access, not just enterprise tenants. You can also use **Read and download system logs** to read the same events directly in C1.
