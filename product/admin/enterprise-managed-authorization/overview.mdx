...
3. [Discover or declare the server's scopes and enable the ones you want to expose](/product/admin/enterprise-managed-authorization/scopes-and-profiles).
4. Bundle scopes into access profiles so users can request them.
5. Users request access through the standard C1 catalog, and approvers grant it.
