...
Functions can be invoked in several ways depending on your use case.
...
- Your **return value** becomes available to subsequent automation steps via the step name (for example, `steps.checkTraining.output.approved`).
