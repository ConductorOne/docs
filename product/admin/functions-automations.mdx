...
description: "Add custom function steps to C1.ai automations to implement complex business logic, integrate with external systems, and make dynamic decisions in your workflows."
og:description: "Add custom function steps to C1.ai automations to implement complex business logic, integrate with external systems, and make dynamic decisions in your workflows."
...
<Steps>
<Step>
Navigate to **Governance** > **Automations** and open your automation in the editor.
</Step>
<Step>
Click **Add Step**.
</Step>
