...
C1 transitions clients through four states. Thresholds are set at the tenant level (**Hide inactive clients after**: 1 day, **Close credentials after**: 1 month, **Delete closed clients after**: 3 months, each settable to zero to disable) but can be overridden per client.
