...
<Info>
Delegation applies only to tasks created **after** the delegate is set. Tasks that were already open when you added the delegate are not retroactively reassigned — they remain assigned to the original user. To move an existing task, reassign it manually from the task's details page (subject to the governing policy's reassignment rules).
</Info>
...
<Info>
Delegation applies only to tasks created **after** the delegate is set. Tasks that were already open before the delegate was added are not retroactively reassigned. To move an existing task, reassign it manually from the task's details page (subject to the governing policy's reassignment rules).
</Info>
