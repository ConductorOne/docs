...
1. **Create** — choose recipients, add content, and set expiration and view limits.
2. **Encrypt** — content is encrypted in your browser before upload.
3. **Share** — send the generated URL to recipients via any channel.
4. **Access** — recipients authenticate via SSO or email magic link, then view or download the content.
