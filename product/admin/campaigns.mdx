...
Edit the campaign as needed, then follow Steps 5 through 7 in [Create a new campaign](/product/admin/campaigns#create-a-new-campaign) to review current data accuracy, prepare the campaign, and start the campaign (if necessary).
