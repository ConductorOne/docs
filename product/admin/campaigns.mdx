...
Fill out the form, providing the following information:
   ...
   - **Review scope type:** Select the type of access review campaign you want to run:
...
Fill out the form, providing the following information:
   ...
   - **Review scope type:** Select the type of access review template you want to create:
