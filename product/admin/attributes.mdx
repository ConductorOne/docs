...
<Steps>
<Step>
Navigate to **Admin** > **Directory** > **User data sources** and select the **Attribute manager** tab.  
...
## View attribute mapping errors

If a CEL-based attribute mapping encounters an error during evaluation, you can view the error details to troubleshoot the issue.
...
<Step>
Look for attributes with an orange triangle indicator, which signals that errors have occurred during mapping evaluation.
</Step>
<Step>
Click **View errors** to see the specific error messages and affected users.
</Step>
</Steps>

This visibility helps you quickly identify and resolve issues with attribute mappings, ensuring user profile data is complete and accurate.
