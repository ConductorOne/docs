...
<Steps>
<Step>
On an app's details page, click **Entitlements** and then click the **Linked entitlements** icon at the top right corner of the entitlements table (the icon looks like a Venn diagram).
