...
| MCP sources      |                      | View, create, manage        | View, manage\*         |                      |                      | View                  | View, create, manage |
...
- Do everything listed in the **Basic User** role
- Add, view, and manage MCP sources across all applications
- Review, approve, and reject tools; create and manage toolsets
- Manage AI clients
- Configure tenant-wide defaults for MCP sources, tools, and AI clients
...
Application Administrators who own an application can review tools and configure per-source and per-tool settings for their own apps. The AI Governance Administrator role spans all applications.
...
- View and manage MCP sources and tools for applications that they own
