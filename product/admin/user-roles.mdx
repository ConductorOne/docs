...
og:description: User roles make sure that C1 users have the correct permissions — and only those permissions — needed to perform their assigned tasks.
description: User roles make sure that C1 users have the correct permissions — and only those permissions — needed to perform their assigned tasks.
