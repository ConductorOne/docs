...
If your user role doesn't grant you access to certain information, C1 hides that information from view rather than showing it. Hidden values appear the same way as other unavailable values on the page — for example, as **Unknown**.
