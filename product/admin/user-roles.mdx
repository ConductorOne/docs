...
|                  | Access Request Admin | AI Governance Administrator | Application Admin      | Campaign Admin       | Connector Admin      | Read-Only Super Admin | Super Admin          |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
†See the **AI Governance Administrator** section for details on which settings and access profile operations are available to users with this role. 
...
- View the AIAM audit log

Users with this role **cannot** enable or disable AI access management for the tenant, assign or revoke user roles, create or delete access profiles, or access non-AIAM areas of C1.
