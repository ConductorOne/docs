...
og:description: Add an administrator, make a user a Super Administrator, or assign any user role in C1. User roles make sure that C1 users have the correct permissions — and only those permissions — needed to perform their assigned tasks.
description: Add an administrator, make a user a Super Administrator, or assign any user role in C1. User roles make sure that C1 users have the correct permissions — and only those permissions — needed to perform their assigned tasks.
...
To **add an administrator**, make a user a **Super Administrator**, or grant any other admin access, assign the matching user role to that user. You can change any user's role assignment on the **Users** page. Users can have more than one role, and a user is granted all the permissions of every role they're assigned. See [Administrator user roles](#administrator-user-roles) for what each admin role can do.
