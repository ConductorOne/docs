...
If your user role doesn't grant you access to certain information, C1 hides that information rather than showing it. Hidden fields appear blank, the same way they would if that information were simply unavailable.
...
When a page contains hidden information, C1 shows a toast message: "Some information on this page is hidden based on your permissions."
