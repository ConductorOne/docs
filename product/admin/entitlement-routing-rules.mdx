...
og:description: Use entitlement routing rules to resolve the request policy and access request settings for many entitlements at once, based on conditions you define—including conditions that match the role and scope of cloud infrastructure apps.
description: Use entitlement routing rules to resolve the request policy and access request settings for many entitlements at once, based on conditions you define—including conditions that match the role and scope of cloud infrastructure apps.
...
* **Fields:** Entitlement name, Resource type ID, and Risk level ID. For cloud infrastructure apps, you can also match on Role name and Scope name.
