...
- **Grant origin**: Whether the grant was created through a C1 ticket workflow or assigned directly in the external system without going through ConductorOne.
