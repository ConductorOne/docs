...
**Done.** The newly created request form is automatically added to the entitlement where you created it. Follow the steps above to add this request form to other entitlements. 
