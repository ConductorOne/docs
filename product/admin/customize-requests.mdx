...
You can create a form from **Governance > Forms**, or from within an individual entitlement:
...
<Step>
Click **Save** in the entitlement's **Access requests** area to apply the new form to the entitlement. 
</Step>
</Steps>
   
**Done.** Follow the steps above to add this request form to other entitlements. 
