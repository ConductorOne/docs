...
**That's it!** The request form will now be shown whenever a user requests this entitlement via the **Requests** page or the **+ New request** form. 
...
**That's it!** The request form will now be shown whenever a user requests one of the selected entitlement via the **Requests** page or the **+ New request** page. 
...
**That's it!** Follow the steps above to add this request form to other entitlements. 
