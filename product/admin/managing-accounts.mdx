...
When app accounts are ingested, ConductorOne automatically attempts to match them to C1 users (the humans in your organization). These mappings are shown in the **Account owner** column. 
