...
description: "Use the C1.ai REST API to create, edit, and publish functions programmatically without the web UI."
og:description: "Use the C1.ai REST API to create, edit, and publish functions programmatically without the web UI."
sidebarTitle: "Manage via the API"
---

Manage functions programmatically through the C1.ai REST API to automate deployments or work outside the web UI. For the web UI workflow, see [Create and test functions](/product/admin/functions-create).
...
All API calls require a bearer token from a personal API key or service principal credential. See [C1.ai API and keys](/conductorone-api/api) for setup.
...
If you omit `commitId`, C1.ai uses the published commit.
