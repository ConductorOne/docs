...
og:title: CEL expressions reference - C1 docs
og:description: Complete reference for CEL expression objects, functions, and usage contexts in C1.
description: Complete reference for CEL expression objects, functions, and usage contexts in C1.
---
...
- `GetAppUserStatus` returns `"USER_STATUS_UNSPECIFIED"` if the user has no account in the app — always compare against the expected status value
