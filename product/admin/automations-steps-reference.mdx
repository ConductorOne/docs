...
**Error behavior:** Fails if the channel doesn't exist or the C1 Slack app doesn't have access, or if a recipient doesn't have a linked Slack account. Requires the [Slack application](/product/admin/integration-for-Slack) to be configured.
