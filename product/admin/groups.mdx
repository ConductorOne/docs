...
<Frame><img src="/images/product/assets/conductorone-groups.png" alt="A screenshot of the C1 app showing a sample ConductorOne group."/></Frame>

ConductorOne groups are collections of ConductorOne users that you create and use within ConductorOne. These groups are resources in [the C1 app](/product/admin/c1-for-c1). 
