...
ConductorOne groups are collections of ConductorOne users that you create and use within ConductorOne. These groups are resources in [the ConductorOne app](/product/admin/c1-for-c1). Like other resources, groups support [visibility controls](/product/admin/managing-resources#resource-visibility-controls) that let you restrict who can see the group to everyone, members only, or owners only.
