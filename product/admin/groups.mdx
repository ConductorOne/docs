...
Create a C1 group by setting a rule for membership. ConductorOne will dynamically add or remove members from the group based on their adherence to the rule. 
