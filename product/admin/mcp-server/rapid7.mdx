---
title: Set up the Rapid7 MCP source
description: Create a Rapid7 InsightVM API account, then add Rapid7 as a Catalog MCP source in C1 and govern the tools your AI clients can call.
og:title: Set up the Rapid7 MCP source
og:description: Create a Rapid7 InsightVM API account, then add Rapid7 as a Catalog MCP source in C1 and govern the tools your AI clients can call.
sidebarTitle: Rapid7
---
...
The Rapid7 Catalog MCP source lets you govern access to Rapid7 InsightVM — assets, vulnerabilities, scans, sites, and reports exposed by the InsightVM Security Console API — as tools your AI clients can call through C1.
...
<Note>
If you don't see **Rapid7** in your MCP source catalog, [contact the C1 support team](mailto:support@c1.ai) to enable it for your tenant.
</Note>
...
## Add the Rapid7 Catalog MCP source in C1

With your console account ready, add the source and provide your credentials.

<Steps>
<Step>
Follow [Add an MCP source](/product/admin/mcp-servers#add-an-mcp-source) and select **Rapid7** from the catalog.
</Step>
<Step>
...
After you add the source, C1 runs tool discovery against Rapid7. Discovered tools appear on the source's **Tools** tab.
...
- **Rotate the password** on the InsightVM console user, then update the password on the source's authentication settings in C1.
