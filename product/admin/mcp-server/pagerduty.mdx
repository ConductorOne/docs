...
<Step>
Set the **Redirect URL** exactly to whichever matches your C1 tenant's domain:
...
<Step>
Set the **Redirect URL** exactly to whichever matches your C1 tenant's domain, then choose the scopes the server needs, such as read access to incidents, services, and users:
