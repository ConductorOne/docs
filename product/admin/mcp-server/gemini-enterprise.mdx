...
<Note>
**This document is not available yet.** Every tenant returns a `404` from this URL until C1 ships it. [Contact the C1 support team](mailto:support@c1.ai) to confirm timing for your tenant before you continue, because the rest of this page depends on having a client ID.
</Note>
