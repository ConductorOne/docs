...
<Step>
Set the **Sign-in redirect URI** to exactly whichever matches your C1 tenant's domain — the value must match exactly, even a trailing-slash difference fails the authorization flow:
