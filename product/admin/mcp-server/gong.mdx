---
title: Set up the Gong MCP source
description: Generate Gong API credentials, then add Gong as a Catalog MCP source in C1 and govern the tools your AI clients can call.
og:title: Set up the Gong MCP source
og:description: Generate Gong API credentials, then add Gong as a Catalog MCP source in C1 and govern the tools your AI clients can call.
sidebarTitle: Gong
---
...
The Gong Catalog MCP source lets you govern access to Gong — calls, transcripts, users, scorecards, deals, sequences, and permission profiles — as tools your AI clients can call through C1.
...
<Note>
If you don't see **Gong** in your MCP source catalog, [contact the C1 support team](mailto:support@c1.ai) to enable it for your tenant.
</Note>
...
## Add the Gong Catalog MCP source in C1

With your credential pair ready, add the source and provide your credentials.

<Steps>
<Step>
Follow [Add an MCP source](/product/admin/mcp-servers#add-an-mcp-source) and select **Gong** from the catalog.
</Step>
<Step>
...
After you add the source, C1 runs tool discovery against Gong. Discovered tools appear on the source's **Tools** tab.
