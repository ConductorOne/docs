...
<Step>
In the app settings sidebar, open **Agents & AI Apps**. Under **Model Context Protocol**, turn on the **Enable MCP** toggle. The manifest can't set this, so turn it on here — without it, Slack's hosted MCP server rejects the app.
</Step>
<Step>
