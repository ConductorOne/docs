...
Use the column picker in the **Apps** table header to adjust which columns are visible — toggle columns on or off and drag to reorder. Your layout is saved automatically.

To export apps data to CSV, click **Download to CSV** above the **Apps** table. An export drawer opens where you can choose which columns to include before generating the file.
