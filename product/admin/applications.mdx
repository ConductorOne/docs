...
C1 supports two types of app owners:

- **User owners**: Specific C1 users you designate as owners of the app.
- **Entitlement owners**: An entitlement from any connected app. All users currently assigned that entitlement automatically become owners of the app, and ownership updates as users are granted or removed from the entitlement.

You can set up to 32 user owners and up to 32 entitlement owners on each app.
...
To edit an app's owners, click the pencil icon next to the **Owners** field in the app's **Overview** header. In the dialog that opens, use the **Users** tab to add or remove user owners, or the **Entitlements** tab to search for and add entitlement owners.

### Edit an app's name, description, or annotations

Click **Edit app details** (the pencil icon) at the top of an app's **Overview** page to open a drawer where you can change the app's display name, description, and icon.
