...
Hover over the app's name, owners, or description at the top of an app's **Overview** page and click the pencil icon to open the **Edit app details**  drawer, where you can update these fields.
...
<Steps>
<Step>
Hover over the app's name at the top of the **Overview** page and click the pencil icon to open the **Edit app details** drawer.  
