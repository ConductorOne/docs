...
Click **Edit app details** (the pencil icon) at the top of an app's **Overview** page to change the app's display name, owners, icon, or description. 
...
**That's it!** The app's new icon is now shown throughout C1. 
