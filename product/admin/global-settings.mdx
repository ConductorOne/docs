...
**That's it!** Your session length has been updated. C1 will require all users in your organization to start new sessions every time the maximum length you selected elapses.  
