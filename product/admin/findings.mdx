...
- **One or more transforms** — set severity, add annotations, remove annotations, or set assignee (assign every matching finding to a specific person as it arrives; a person's own manual assignment on a finding always overrides a later rule).
