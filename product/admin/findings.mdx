...
The following finding types are available today, grouped by category. Types marked **On by default** start detecting immediately; everything else needs to be turned on from the settings menu.
