...
- Connect your AI client to C1 — go to **Profile > AI & API**, copy the MCP Server URL, and add it to your AI client (Claude Desktop, Claude Code, ChatGPT, Cursor, and so on).
