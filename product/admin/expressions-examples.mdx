...
og:title: CEL expressions examples - C1.ai docs
og:description: Practical examples, common patterns, and real-world use cases for CEL expressions in C1.ai.
description: Practical examples, common patterns, and real-world use cases for CEL expressions in C1.ai.
---
