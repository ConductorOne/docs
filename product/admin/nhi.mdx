...
<Note>
**NHI capabilities are under active development.** Classification, ownership, and policy support for non-human identities will keep expanding — see the [release notes](/product/release-notes) for updates.
</Note>
