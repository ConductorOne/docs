...
- **All approved** — every tool in **Approved** state across the server.
- **Read-only** — every **Approved** tool with Action = Read.
...
<Step>
Add the toolset as an entitlement — both C1-maintained toolsets (**All approved**, **Read-only**) and custom toolsets appear as options.
</Step>
<Step>
