...
Use **Configure columns** in the **Entitlements** table header to adjust which columns are visible — toggle columns on or off and drag to reorder. Your layout is saved automatically.
