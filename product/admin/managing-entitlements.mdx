...
Use the column picker in the **Entitlements** table header to adjust which columns are visible — toggle columns on or off and drag to reorder. Your layout is saved automatically.

To export entitlements data to CSV, click **Download to CSV** above the **Entitlements** table. An export drawer opens where you can choose which columns to include before generating the file.
