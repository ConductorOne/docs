...
In C1 we call attention to entitlements by showing them next to the resource. This is known as the entitlement _slug_. The slug is a short term that describes the access right or permission. The word or words inside that oval tell you exactly what permission the entitlement grants.
...
To edit an entitlement's owners, click **Edit** in the owners section of the entitlement detail page. In the dialog that opens, use the **Users** tab to add or remove user owners, or the **Entitlements** tab to search for and add entitlement owners.
