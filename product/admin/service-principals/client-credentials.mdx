...
og:title: "Quick start: Client credentials - C1.ai docs"
...
<Steps>
  <Step>
    Navigate to **Identities** in the left sidebar, then click **Service principals**.
  </Step>
  <Step>
...
Configure the [C1.ai Terraform provider](/developer/terraform) with your service principal credentials. The server URL is derived automatically from the client ID, so you only need two values:
