...
og:title: Service principals - C1 docs
...
<Tip>
You don't need a service principal to use the C1 API for personal use. You can use existing personal API credentials (**Profile** > **API Keys**) for individual tasks. Service principals are designed for shared automation where the identity should not be tied to a specific person.
</Tip>
...
1. Contact your C1 account team to enable the feature (it's gated behind a feature flag during early access)
