...
og:title: Security controls - C1.ai docs
...
On the service principal's **Details** tab, the **Role** field assigns one or more of C1.ai's standard roles to the service principal -- the same roles you'd assign to a human user. See [User roles](/product/admin/user-roles) for the full list and descriptions of each role.
...
All service principal and workload federation activity is recorded in the C1.ai system log.
