...
og:description: View, edit, disable, rotate credentials, and assign owners for service principals.
description: View, edit, disable, rotate credentials, and assign owners for service principals.
...
<Steps>
  ...
  <Step>
    Click the menu on the credential you want to revoke.
  </Step>
  <Step>
...
<Note>
Credential expiration can't be extended. If you need a longer-lived credential, create a new one with the desired expiration and revoke the old one.
</Note>
...
<Steps>
  ...
  <Step>
    Click the menu on the trust you want to delete.
  </Step>
  <Step>
