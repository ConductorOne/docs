...
og:title: GitHub Actions integration - C1 docs
og:description: Set up secretless authentication from GitHub Actions to C1 using the oidc-token-action.
description: Set up secretless authentication from GitHub Actions to C1 using the oidc-token-action.
