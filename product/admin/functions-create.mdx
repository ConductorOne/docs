...
description: "Learn how to create, write, test, and publish C1 functions using the built-in code editor."
og:description: "Learn how to create, write, test, and publish C1 functions using the built-in code editor."
...
To get started, open a function's detail page and click **Copilot** in the code editor toolbar.

<Frame><img src="/images/product/assets/functions-copilot.png" alt="The function detail page showing the Copilot panel open alongside the code editor." /></Frame>
...
<Note>
Before using the SDK, configure your function's scopes to allow access to C1 APIs. See [Scopes](/product/admin/functions-reference#scopes) in the reference documentation.
</Note>
