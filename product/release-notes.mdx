...
### Review assistant is now available to all customers

The [review assistant](/product/how-to/review-tasks) is now available to all ConductorOne customers with both the **Access Reviews** and **Copilot** add-ons. Previously available as early access, the assistant is now enabled automatically for eligible tenants — no setup required.
