...
- The **Automations** page now includes an **Executions** tab with a combined log of all automation runs across your organization. Filter by automation, status, or date to find specific runs — without navigating to each automation individually.
