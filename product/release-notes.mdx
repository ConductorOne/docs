...
HTTP Basic Auth for MCP servers can now be configured in two credential modes. See [Configure authentication](/product/admin/mcp-servers#configure-authentication) for details.
