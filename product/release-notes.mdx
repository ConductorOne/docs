...
*A quick note on format: C1 release notes are now on a biweekly cadence for product roundups, so each digest has enough substance to be worth your time. Major launches still go out the day they ship — this roundup is for everything else.*
