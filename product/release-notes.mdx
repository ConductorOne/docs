...
### Ask C1AI is now available in the product

The C1 AI assistant is now built directly into C1. Click **Ask C1AI** in the bottom-right corner of any page to open a floating chat panel, ask questions about your org's access data, and take action with your explicit approval.
