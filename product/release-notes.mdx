...
- **Richer AI assistant responses in Slack**: The C1 AI assistant in Slack now uses rich interactive responses — buttons, forms, and pickers — so users can complete tasks without leaving the conversation.

- **Slack conversations in the admin console**: The Agentic AI **Conversations** page now has separate **Web** and **Slack** tabs with full visibility of agent activity across both surfaces. 
...
- **Entitlement owners in the table and exports**: Each application's **Entitlements** table now includes an **Owners** column, also reflected in the CSV export.
...
- **Markdown supported in requestable form field helper text**: Admins can now use markdown — links, bold, lists — in the guidance shown to requesters on form fields.
