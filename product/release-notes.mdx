...
* Linked service desk tickets now open in a new browser tab when clicked. This allows you to keep your ConductorOne view open in one tab while reviewing the linked ticket in another, providing a smoother workflow when managing access requests with external ticketing integrations.
