...
You can now connect AI assistants — including Claude Desktop, Claude Code, Codex, Cursor, and VS Code — to your C1 data using the Model Context Protocol (MCP). Once enabled, users can connect from their profile under **AI & API** > **AI connections** and paste the MCP server URL into their AI tool. Connected assistants can query users, resources, entitlements, access reviews, and more. All queries are read-only and logged in the system log.
