...
You can now assign a workflow step in a request or review policy to C1AI. The agent evaluates each request that reaches the step using C1's built-in guidance plus any custom instructions you provide.
