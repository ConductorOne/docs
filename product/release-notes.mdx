...
* **Built-in risk context:** Ownership status and existing findings surface right in the dashboard, so you can immediately see which NHIs are unowned or flagged as risks.

### Get AI help setting up campaigns
