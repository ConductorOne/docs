...
### Assign a finding to a specific owner
...
- **Policy comments now show you what they'll actually post.** Wait-step and SLA-violation comment fields support Markdown styling, and the policy summary renders the comment instead of showing raw markdown source. {/* PR #23155 */}
