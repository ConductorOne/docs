...
- Campaign reports now support custom column selection. When generating a report, choose between the default column set or a custom set that includes **Employee ID**.
