...
### Cloud infrastructure governance with hierarchical access modeling
...
This initial release supports [Azure](/baton/azure). Access requests, access reviews, JML automation, and provisioning all work on the hierarchical model from day one.
...
See [Entitlement routing rules](/product/admin/entitlement-routing-rules) for details.
