...
See [Automation circuit breaker](/product/admin/automations-circuit-breaker) for configuration details.{/* TODO: verify link */}
...
You can now attach custom key/value annotations to policies, app entitlements, access profiles, automations, and group-type app resources. Annotations are available through the C1 API, OpenAPI spec, and C1 Terraform provider.
...
See [Object annotations](/product/admin/object-annotations) for details.{/* TODO: verify link */}
