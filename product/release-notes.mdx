...
{/* Screenshot needed: the Agent step configuration panel in the policy rule editor (Agent mode / Agent failure action / Agent instructions fields).
<Frame>
...
{/* Screenshot needed: the "View access graph" expansion (see 3b/3d in reference screenshots) is the clearest single shot — shows the requested team entitlement plus its GRANTS list with the searched-for repo highlighted "You searched for this".
<Frame>
