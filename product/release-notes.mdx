...
- **Reviewer denial reasons reach your ticketing system automatically.** Access-review revoke tasks now include the reviewer's justification, available to external ticket templates as `.Description`, `ReviewTaskNumber`, `ReviewTaskURL`, and `DeniedBy`. {/* PR #25108 */}
