...
Learn about this week's connector updates and new connectors in the [connector release notes](/baton/_release-notes.mdx).

</Update>

{/* ### Role mining

Role mining now has a dedicated home at **Governance** > **Role mining**. ConductorOne continuously analyzes access patterns across your organization and surfaces suggested access profiles, grouped by cohorts like department, job title, and manager's team. Each suggestion includes a confidence score for every recommended entitlement, so you can quickly assess fit before accepting. You can also define a custom cohort and run a targeted analysis on demand.

To learn more, see [Use role mining](/product/admin/role-mining).*/}
