...
The campaign setup flow and reviewer task list have been refreshed with clearer labels and more compact controls.

- **Campaign staging** is now a single **Stage campaign** step that includes scope validation.
- **Reviewer task list** actions use icon buttons with tooltips, keeping more of each review row visible.
- To view your submissions, use the **...** (more actions) menu at the top of the reviews page.

See [Create a campaign](/product/admin/campaigns) and [Complete access review tasks](/product/how-to/review-tasks) for full details.
