...
{/* TODO: docs update - product/admin/ai-assistant.mdx exists and covers general Q&A/reporting/onboarding, but has no section on task diagnosis yet. Add one and link this paragraph to it before publishing. */}
{/* PR #25528 */}
...
- **Identities & NHI is now available to every tenant.** The redesigned Inventory page - with dedicated Overview, Human users, Service, Secrets, NHI, and Agents tabs - was previously limited availability; it's now open to everyone. {/* PR #24792 */}
