...
- You can now display your organization's name and logo in the ConductorOne interface. Navigate to **Settings** > **Branding** to upload your logo and set a display name. {/* docs */}
