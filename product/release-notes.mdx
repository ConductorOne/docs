...
*Visit the [connector release notes](https://www.conductorone.com/docs/baton/_release-notes) for this week’s connector updates.*
...
_Visit the [connector release notes](/baton/_release-notes) for this week's connector updates._
...
* The [Jira Data Center](/baton/jira-data-center) connector now supports account provisioning. 
...
- New this week: [Temporal Cloud](/baton/temporal-cloud), [Confluence v2](/baton/confluence-v2), and [Cloudflare v2](/baton/cloudflare-v2).
...
- There are now two options when integrating [Entra ID](/baton/entra): use OAuth, or create an Entra app and assign it API permissions.
...
- Now generally available: [Entra ID](/baton/entra), [AWS v2](/baton/aws-v2), and [Google Workspace v2](/baton/google-workspace-v2).
...
**Updated integrations.** Five integrations are now generally available: [New Relic](/baton/newrelic), [Xero](/baton/xero), [Hubspot](/baton/hubspot), [Segment](/baton/segment), and [SentinelOne](/baton/sentinelone). Check out the documentation to get started with these integrations, and let us know what else you'd like to see added to the integration library!
...
**Updated integrations.** Three integrations are now generally available: [Snipe-IT](/baton/snipeit), [Fastly](/baton/fastly), and [GitHub Enterprise](/baton/github-enterprise). Check out the documentation to get started with these integrations today.
...
**New integration.** We've added [Snipe-IT](/baton/snipeit) to the integrations library. This integration is currently in early access as we fine-tune its details and gather feedback. If you're ready to set up your Snipe-IT integration, let us know!
...
**Updated integrations.** We're happy to announce four integrations are now generally available: [Broadcom SAC](/baton/broadcom), [CrowdStrike](/baton/crowdstrike), [ServiceNow](/baton/servicenow), and [Cortex XSOAR](/baton/xsoar). Check out the documentation to get started with these integrations, and let us know what else you'd like to see added to the integration library!
...
**New integrations.** Joining the integrations library this week are [Broadcom SAC](/baton/broadcom) and [Cortex XSOAR](/baton/xsoar). These new integrations are in early access while we gather feedback and fine-tune their details. If you're keen to try them out, let us know!
