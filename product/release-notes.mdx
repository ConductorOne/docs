...
### Trigger requestable actions from the AI assistant

The AI assistant can now do more than answer questions — you can use it to discover and trigger **requestable actions** directly from the chat, on the web or in Slack. Ask what actions are available to you, pick one, and the assistant surfaces the form right in the conversation. Every submission is a deliberate click on your part, and requests run through the same approval policies as always.

{/* TODO: screenshot of the assistant rendering a requestable action form */}
...
{/* TODO: update managing-resources.mdx to cover assigning entitlements as resource owners */}
...
{/* TODO: update object-annotations.mdx to cover using annotations in CEL expressions */}
...
{/* TODO: update automations docs to cover multiple recipients in Store credential step */}
