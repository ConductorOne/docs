...
- Campaigns can now be configured to start and end automatically, eliminating the need for manual intervention. When a campaign is set to auto-start, we'll review data accuracy before launch and notify campaign admins of any issues—you can choose whether campaigns should proceed automatically or wait for manual review when data issues are detected. Learn more about auto-start configuration.
