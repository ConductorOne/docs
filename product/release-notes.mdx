...
- Reviewers can now switch to a **By resource** view when completing access review tasks. The resource view groups your assigned tasks by resource, to help you make consistent decisions about who should have access to a specific application or resource.
