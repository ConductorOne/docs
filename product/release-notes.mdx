...
Find every report you've saved on the new **Platform > Reporting** page — refresh it, edit it with the **Report assistant**, or review the sources behind its results. See [Save and revisit reports](/product/admin/reporting) for details.
