...
- List pages for applications, connectors, access review campaigns, automations, and more now include counts and 30-day trend cards, so you can assess activity at a glance without opening individual records. The webhooks and Shared Signals receiver tables also show a per-row sparkline with recent activity volume.
