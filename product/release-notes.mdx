...
Ready to get started with service principals? Contact the ConductorOne Support team to enable the feature for your tenant. he new review assistant is an AI agent that helps you complete your assigned access review tasks. The agent understands the context of your current campaign, so you can tell it what to do in plain language: approve or deny tasks for specific users, act on entitlements, follow recommendations, manage pending actions, or handle bulk operations across multiple reviews.
...
- The 2025 year in review banner has been removed from your **Home** page. You can still access your 2025 year in review any time by navigating to `<your_domain>.conductor.one/admin/yearly-review/2025`.
