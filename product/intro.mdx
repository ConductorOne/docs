...
og:title: Intro | Docs - C1
og:description: Welcome to the C1 documentation! C1 offers streamlined access request and review processes, centralized access lifecycle audit and reporting.
...
<Columns cols={1}>
  <Card title="C1's public IP addresses" icon="server" horizontal href="/product/admin/egress-ips">
  Add C1 egress IPs to your allowlist to enable outbound connector and function traffic to reach your systems.
  </Card>
