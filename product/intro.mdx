...
og:description: C1 is an identity security platform for governing access across human, non-human, and AI identities. Govern AI agent and MCP server access, provision and deprovision access, enable self-service requests, and run access reviews.
description: C1 is an identity security platform for governing access across human, non-human, and AI identities. Govern AI agent and MCP server access, provision and deprovision access, enable self-service requests, and run access reviews.
---
...
C1 connects to your apps through [connectors](/baton/intro), governs access with [policies and automations](/product/admin/automations), and lets your users sign in with [single sign-on](/product/admin/sso).
