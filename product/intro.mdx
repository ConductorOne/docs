...
og:description: ConductorOne (C1) is an identity security platform for identity governance. Run access reviews, enable self-service and just-in-time access requests, provision and deprovision access, and audit who has access to what.
description: ConductorOne (C1) is an identity security platform for identity governance. Run access reviews, enable self-service and just-in-time access requests, provision and deprovision access, and audit who has access to what.
---
{/* Editor Refresh: 2026-01-07 */}

## <Icon icon="circle-question" size={24} />   What is ConductorOne?

ConductorOne (C1) is an identity security platform for identity governance and administration (IGA). C1 helps you automate access across your human, non-human, and AI identities. With C1, you can:
