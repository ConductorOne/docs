...
<Columns cols={1}>
  <Card title="ConductorOne's public IP addresses" icon="server">
  Add these egress IPs to your allowlist to enable outbound traffic from ConductorOne to reach your systems.
