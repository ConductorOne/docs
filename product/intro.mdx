...
<Tip>
<Icon icon="magnifying-glass" /> **Looking for the connector docs?**
 
The connector docs have a new home! Click **Connector docs** in the menu bar above to explore their dedicated docs site.
</Tip>
...
<Columns cols={2}>
<Card title="Connectors library" icon="arrow-right" horizontal href="/product/integrations/" />
<Card title="API documentation" icon="arrow-right" horizontal href="/conductorone-api/a76uioi122862-how-to-authenticate-requests" />
