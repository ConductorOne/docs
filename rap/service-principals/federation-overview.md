...
2. Workflow sends JWT to C1.ai token exchange endpoint
3. C1.ai validates: issuer, signature, audience, freshness, CEL conditions
4. C1.ai issues short-lived access token scoped to service principal's roles
