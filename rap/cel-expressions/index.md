...
This directory contains focused documentation chunks for CEL (Common Expression Language) in C1.ai. Each file is self-contained and designed for selective retrieval.

## How to Use This Index

When answering questions about CEL expressions in C1.ai:
