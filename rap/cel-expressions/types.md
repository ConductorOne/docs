...
This document covers all types used in C1.ai CEL expressions: primitives, time types, collections, enums, and object types.
...
| Value | Meaning |
|:------|:--------|
| `TaskOrigin.WEBAPP` | Created in C1.ai web interface |
...
- **User** = A person in the C1.ai directory (synced from identity provider)
...
A person in the C1.ai directory.
...
A C1.ai group (entitlement in the builtin Groups app).
